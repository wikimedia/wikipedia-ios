public enum WMFUserDefaultsKey: String {
    ...
    case autoSignTalkPageDiscussions = "settings-auto-sign-talk-page-discussions"
    case showSearchLanguageBar = "settings-show-search-language-bar"
    case openAppOnSearchTab = "settings-open-app-on-search-tab"
}
