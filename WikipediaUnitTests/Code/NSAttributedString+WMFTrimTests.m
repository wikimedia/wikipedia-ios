...
- (NSAttributedString *)attrString {
  NSMutableAttributedString *attributedText = [[NSMutableAttributedString alloc]
      initWithString:@" \n \n This is a test string which should help confirm "
                     @"that this is working the way we want it to.  \n"];
...
- (void)testAllWhiteSpaceString {
  assertThat([[[NSMutableAttributedString alloc]
                  initWithString:@"\n \n   \n   "] wmf_trim]
                 .string,
             is(equalTo(@"")));
}
