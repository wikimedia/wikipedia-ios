...
- (NSString *)allObamaHTML {
  return [[[self loadJSON:@"Obama"][@"mobileview"][@"sections"]
      bk_map:^NSString *(NSDictionary *section) {
        return section[@"text"];
...
- (NSURL *)obamaLeadImageURL {
  return [NSURL URLWithString:@"https://upload.wikimedia.org/wikipedia/commons/"
                              @"thumb/f/f1/BarackObamaportrait.jpg/"
                              @"816px-BarackObamaportrait.jpg"];
}
