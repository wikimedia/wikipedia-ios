...
- (void)testEmpty {
  ...
  MWKProtectionStatus *protection =
      [[MWKProtectionStatus alloc] initWithData:data];
...
- (void)testEquals {
  ...
  MWKProtectionStatus *protectionEmpty1 =
      [[MWKProtectionStatus alloc] initWithData:dataEmpty];
  MWKProtectionStatus *protectionEmpty2 =
      [[MWKProtectionStatus alloc] initWithData:dataEmpty];
  MWKProtectionStatus *protectionObama1 =
      [[MWKProtectionStatus alloc] initWithData:dataObama];
  MWKProtectionStatus *protectionObama2 =
      [[MWKProtectionStatus alloc] initWithData:dataObama];
...
- (void)testRoundTrip {
  ...
  MWKProtectionStatus *protectionEmpty2 =
      [[MWKProtectionStatus alloc] initWithData:[protectionEmpty1 dataExport]];
  MWKProtectionStatus *protectionObama2 =
      [[MWKProtectionStatus alloc] initWithData:[protectionObama1 dataExport]];
