...
/**
 *  Shared tests for persisting @c MWKList subclasses which conform to @c
 * MWKDataStoreList
 */
 ...
 *
 *  Default implementation checks `isEqual:` of both lists' entries. Override
 * this method to
 *  add additional verification, but call @c super if you need `isEqual:`
 * checked as well.
 *
