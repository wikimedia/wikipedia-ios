...
- (NSAttributedString *)getTestAttrStr {
  NSMutableAttributedString *attributedText = [[NSMutableAttributedString alloc]
      initWithString:@"This is a test string which should help confirm that "
                     @"this is working the way we want it to. This is a test "
                     @"link to wikipedia."];

  [attributedText addAttribute:NSStrikethroughStyleAttributeName
                         value:@1
                         range:[attributedText.string rangeOfString:@"This"]];
  [attributedText addAttribute:NSStrikethroughStyleAttributeName
                         value:@1
                         range:[attributedText.string rangeOfString:@"test"]];
  [attributedText addAttribute:NSStrikethroughStyleAttributeName
                         value:@1
                         range:[attributedText.string rangeOfString:@"which"]];
  [attributedText addAttribute:NSStrikethroughStyleAttributeName
                         value:@1
                         range:[attributedText.string rangeOfString:@"help"]];

  [attributedText addAttribute:NSBackgroundColorAttributeName
                         value:[UIColor greenColor]
                         range:[attributedText.string rangeOfString:@"should"]];
  [attributedText
      addAttribute:NSBackgroundColorAttributeName
             value:[UIColor greenColor]
             range:[attributedText.string rangeOfString:@"working"]];
  [attributedText addAttribute:NSBackgroundColorAttributeName
                         value:[UIColor grayColor]
                         range:[attributedText.string rangeOfString:@"way"]];
  ...
  [attributedText addAttribute:NSLinkAttributeName
                         value:url
                         range:[attributedText.string rangeOfString:@"link"]];
...
- (void)testRemoveAllStrikeThroughs {
  NSAttributedString *attrStr = [[self getTestAttrStr]
      wmf_attributedStringChangingAttribute:NSStrikethroughStyleAttributeName
...
- (void)testChangeGreenBackgroundColorsToBlue {
  NSAttributedString *attrStr = [[self getTestAttrStr]
      wmf_attributedStringChangingAttribute:NSBackgroundColorAttributeName
...
- (void)testChangeReduceLineSpacing {
  NSAttributedString *attrStr = [[self getTestAttrStr]
      wmf_attributedStringChangingAttribute:NSParagraphStyleAttributeName
                                  withBlock:^NSParagraphStyle *(
                                      NSParagraphStyle *paragraphStyle) {
                                    NSMutableParagraphStyle *mutablePStyle =
...
- (void)testRemovingLink {
  NSAttributedString *attrStr = [[self getTestAttrStr]
      wmf_attributedStringChangingAttribute:NSLinkAttributeName
                                  withBlock:^id(id link) {
                                    return nil;
                                  }];
  attrStr = [attrStr
      wmf_attributedStringChangingAttribute:NSForegroundColorAttributeName
                                  withBlock:^UIColor *(UIColor *color) {
                                    return nil;
                                  }];
  [self wmf_verifyMultilineLabelWithText:attrStr width:320.f];
