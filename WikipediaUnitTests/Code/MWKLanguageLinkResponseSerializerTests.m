...
- (void)testNullHandling {
  ...
  NSData *badResponseData =
      [NSJSONSerialization dataWithJSONObject:badResponse options:0 error:nil];
  id serializedResponse =
      [serializer responseObjectForResponse:nil data:badResponseData error:nil];
