...
class NotificationsCenterCellViewModelGenericTests: NotificationsCenterViewModelTests {
    ...
    private func testPageReviewActions(cellViewModel: NotificationsCenterCellViewModel) throws {
        ...
        try testActions(expectedText: expectedText3, expectedURL: expectedURL3, expectedIcon: expectedIcon3, expectedDestinationText: expectedDestinationText3, actionToTest: cellViewModel.sheetActions[3], actionType: nil)
