...
class NotificationsCenterDetailViewModelGenericTests: NotificationsCenterViewModelTests {
    ...
    private func testPageReviewActions(detailViewModel: NotificationsCenterDetailViewModel) throws {
        ...
        try testActions(expectedText: expectedText1, expectedURL: expectedURL1, expectedIcon: expectedIcon1, expectedDestinationText: expectedDestinationText1, actionToTest: detailViewModel.secondaryActions[1], actionType: nil)
    }
