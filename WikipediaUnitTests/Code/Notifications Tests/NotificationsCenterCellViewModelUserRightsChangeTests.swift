...
class NotificationsCenterCellViewModelUserGroupRightsChangeTests: NotificationsCenterViewModelTests {
    ...
    private func testUserRightsChangeActions(cellViewModel: NotificationsCenterCellViewModel) throws {
        ...
        let expetedAction: RemoteNotificationActionType = .markUnread
        ...
        let expetedAction1: RemoteNotificationActionType = .listGroupRights
        ...
        let expetedAction2: RemoteNotificationActionType = .listGroupRights
        ...
        let expetedAction3: RemoteNotificationActionType = .senderPage
        ...
        let expetedAction4: RemoteNotificationActionType = .settings
