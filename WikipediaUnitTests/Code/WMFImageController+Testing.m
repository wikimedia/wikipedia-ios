...
+ (instancetype)temporaryController {
  SDImageCache *tempCache =
      [[SDImageCache alloc] initWithNamespace:@"temp"
                                  inDirectory:WMFRandomTemporaryPath()];
  SDWebImageManager *manager = [[SDWebImageManager alloc]
      initWithDownloader:[[SDWebImageDownloader alloc] init]
                   cache:tempCache];
