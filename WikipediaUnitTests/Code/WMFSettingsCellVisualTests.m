...
- (void)verifyCell:(WMFSettingsTableViewCell *)cell
...
- (void)testLongTitle {
  [self verifyCell:self.cell
         withTitle:@"This should be at least five or six lines of text so we "
                   @"can obviously see that the cell height grows to "
                   @"encompass long translations even though they'll probably "
                   @"never be this long."];
}
