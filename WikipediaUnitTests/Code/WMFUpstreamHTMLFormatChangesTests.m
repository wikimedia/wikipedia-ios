...
- (void)testFormatOfScaledImageTagsHasNotChangedOnBeta {
  ...
  XCTestExpectation *expectation = [self
      expectationWithDescription:@"Fetch img tag html for a piece of image "
                                 @"wikitext. Thus way we can be notified when "
                                 @"image tag formatting changes in any way so "
                                 @"we can ensure image "
                                 @"widening/caching/proxying still work with "
  ...
  NSURLSessionDataTask *dataTask = [session
      ...
      completionHandler:^(NSData *data, NSURLResponse *response,
        ...
        NSString *expectedHTML =
            @""
             "<div class=\"mf-section-0\"><p><a href=\"/wiki/MediaWiki\" "
             "title=\"MediaWiki\">"
             "<img alt=\"Example.jpg\" "
             "src=\"//upload.beta.wmflabs.org/wikipedia/commons/thumb/a/a9/"
             "Example.jpg/20px-Example.jpg\" width=\"20\" height=\"21\" "
             "srcset=\"//upload.beta.wmflabs.org/wikipedia/commons/thumb/a/a9/"
             "Example.jpg/30px-Example.jpg 1.5x, "
             "//upload.beta.wmflabs.org/wikipedia/commons/thumb/a/a9/"
             "Example.jpg/40px-Example.jpg 2x\" data-file-width=\"172\" "
             "data-file-height=\"178\">"
             "</a></p>\n\n\n\n\n\n</div>";

        // Don't fail on whitespace changes.
        html = [html wmf_trimAndNormalizeWhiteSpaceAndNewlinesToSingleSpace];
        expectedHTML = [expectedHTML
            wmf_trimAndNormalizeWhiteSpaceAndNewlinesToSingleSpace];
