...
class TalkPageNetworkDataTests: XCTestCase {
    ...
    func testLocalJsonDecodesToTalkPage() {
        do {
            ...
            XCTAssertEqual(topics[0].text, "Would you please help me expand the Puppy cat article?", "Unexpected topic title")
            XCTAssertEqual(topics[0].replies.count, 2, "Unexpected replies count")
            let firstItem = topics[0].replies[0]
            XCTAssertEqual(firstItem.text, "Hi Pixiu! Glad we were able to meet at the Bay Area Puppercat Edit-a-thon last week. I noticed that the <a href=\'https://en.wikipedia.org/wiki/Puppy_cat\'>Puppy cat</a> could use some more information about ragdolls, do you think that this might be something you\'d be interested in contributing to? <a href=\'https://en.wikipedia.org/wiki/User:Fruzia\'>Fruzia</a> (<a href=\'https://en.wikipedia.org/wiki/User_talk:Fruzia\'>talk</a>) 23:08. 20 March 2019 (UTC)", "Unexpected reply text")
