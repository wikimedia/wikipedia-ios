...
@interface WMFCollectionViewExtensionTests
    : XCTestCase <UICollectionViewDataSource>
...
- (void)testNext {
  ...
  NSIndexPath *next =
      [self.collectionView wmf_indexPathAfterIndexPath:indexPath];
...
- (void)testPrevious {
  ...
  NSIndexPath *previous =
      [self.collectionView wmf_indexPathBeforeIndexPath:indexPath];
