...
/**
 *  Get UILabel configured to 320 width and dynamic height based on length of
 * text being shown.
...
/**
 *  Get UITableViewCell configured to 320 width and dynamic height based on
 * autolayout properties of its subviews.
 *  Useful for quick FBSnapshotTestCase test cases.
 *
