...
- (void)testComplexAttributedStringCreation {
  // First create complex attributed string (complexAttributedString1) using our
  // substitution method:
      ...
      [@"Large orange text and some $1 and $2 text. More $1 text."
          attributedStringWithAttributes:self.largeOrangeText
                  ...
                  substitutionAttributes:@[
                    self.smallGreenText, self.mediumBlueText
                  ]];

  // Now create identical complex attributed string (complexAttributedString2)
  ...
  [complexAttributedString2
      appendAttributedString:[[NSMutableAttributedString alloc]
                                 initWithString:@"Large orange text and some "
                                     attributes:self.largeOrangeText]];
  [complexAttributedString2
      appendAttributedString:[[NSMutableAttributedString alloc]
                                 initWithString:@"small green"
                                     attributes:self.smallGreenText]];
  [complexAttributedString2
      appendAttributedString:[[NSMutableAttributedString alloc]
                                 initWithString:@" and "
                                     attributes:self.largeOrangeText]];
  [complexAttributedString2
      appendAttributedString:[[NSMutableAttributedString alloc]
                                 initWithString:@"medium blue"
                                     attributes:self.mediumBlueText]];
  [complexAttributedString2
      appendAttributedString:[[NSMutableAttributedString alloc]
                                 initWithString:@" text. More "
                                     attributes:self.largeOrangeText]];
  [complexAttributedString2
      appendAttributedString:[[NSMutableAttributedString alloc]
                                 initWithString:@"small green"
