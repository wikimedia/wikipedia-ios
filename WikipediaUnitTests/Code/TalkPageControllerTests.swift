...
class TalkPageControllerTests: XCTestCase {
    ...
    override func setUp() {
        ...
        talkPageController = TalkPageController(talkPageFetcher: talkPageFetcher, articleRevisionFetcher: articleRevisionFetcher, dataStore: tempDataStore, name: "Username1", host: Configuration.Domain.englishWikipedia)
    ...
    func testFetchSameUserDifferentLanguageAddsMultipleTalkPageRecords() {
        ...
        talkPageController = TalkPageController(talkPageFetcher: talkPageFetcher, articleRevisionFetcher: articleRevisionFetcher, dataStore: tempDataStore, name: "Username1", host:"es.wikipedia.org")
    ...
    func testFetchDifferentUserSameLanguageAddsMultipleTalkPageRecords() {
        ...
        talkPageController = TalkPageController(talkPageFetcher: talkPageFetcher, articleRevisionFetcher: articleRevisionFetcher, dataStore: tempDataStore, name: "Username2", host:Configuration.Domain.englishWikipedia)
