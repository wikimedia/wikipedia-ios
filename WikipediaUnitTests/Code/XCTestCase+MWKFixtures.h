...
/**
 * Create an article from fixture data, give it the specified title, and insert
 it into the given data store.
 *
 * The fixture data should be JSON, which can either be the raw response from
 mobileview or the JSON returned by
 * `-[MWKArticle dataExport]`. Keep in mind that other properties of the article
 might not be populated.

 * @param fixtureName   The name of the JSON file you want to use (e.g. "Obama"
 for "Obama.json"), see description for
