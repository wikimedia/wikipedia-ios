...
- (void)testStrings {
  XCTAssertEqualObjects([siteURL wmf_URLWithTitle:@"India"].wmf_title,
                        @"India");
  XCTAssertEqualObjects([siteURL wmf_URLWithTitle:@"Talk:India"].wmf_title,
                        @"Talk:India");
  XCTAssertEqualObjects(
      [NSURL wmf_URLWithSiteURL:siteURL
          escapedDenormalizedTitleAndFragment:@"Talk:India#History"]
          .wmf_title,
      @"Talk:India");
}

- (void)testLinks {
  XCTAssertEqualObjects([NSURL wmf_URLWithSiteURL:siteURL
                            escapedDenormalizedInternalLink:@"/wiki/India"]
                            .wmf_title,
                        @"India");
  XCTAssertEqualObjects([NSURL wmf_URLWithSiteURL:siteURL
                            escapedDenormalizedInternalLink:@"/wiki/Talk:India"]
                            .wmf_title,
                        @"Talk:India");

  XCTAssertEqualObjects(
      [NSURL wmf_URLWithSiteURL:siteURL
          escapedDenormalizedInternalLink:@"/wiki/Talk:India#History"]
          .wmf_title,
      @"Talk:India");
  XCTAssertEqualObjects([NSURL wmf_URLWithSiteURL:siteURL
                            escapedDenormalizedInternalLink:
                                @"/wiki/2008 ACC Men%27s Basketball Tournament"]
                            .wmf_title,
