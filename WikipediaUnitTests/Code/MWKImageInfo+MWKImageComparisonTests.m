...
- (void)testAssociation {
  MWKImage *image =
      [MWKImage imageAssociatedWithSourceURL:
                    @"/thumb/some_file_name.jpg/400px-some_file_name.jpg"];
  MWKImageInfo *info =
      [MWKImageInfo infoAssociatedWithSourceURL:
                        @"/thumb/some_file_name.jpg/800px-some_file_name.jpg"];
...
- (void)testDisassociation {
  MWKImage *image =
      [MWKImage imageAssociatedWithSourceURL:
                    @"/thumb/some_file_name.jpg/400px-some_file_name.jpg"];
  MWKImageInfo *info = [MWKImageInfo
      infoAssociatedWithSourceURL:
          @"/thumb/other_file_name.jpg/800px-other_file_name.jpg"];
  assertThat([image infoAssociationValue],
             isNot(equalTo([info imageAssociationValue])));
