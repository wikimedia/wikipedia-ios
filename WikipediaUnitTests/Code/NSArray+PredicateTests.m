...
- (void)testEmptyArray {
  assertThat(
      [@[] wmf_firstMatchForPredicate:[NSPredicate predicateWithValue:YES]],
      is(nilValue()));
  assertThat(
      [@[] wmf_firstMatchForPredicate:[NSPredicate predicateWithValue:NO]],
      is(nilValue()));
}
...
- (void)testPerformance {
  ...
  [self measureBlock:^{
    [testArray
        wmf_firstMatchForPredicate:[NSPredicate predicateWithBlock:^BOOL(
                                                    NSNumber *x,
