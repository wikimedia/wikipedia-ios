...
public class CommonStrings: NSObject {
    ...
    @objc public static let profileButtonTitle = WMFLocalizedString("profile-button-accessibility-label", value: "Profile", comment: "Accessibility label the profile navigation bar button. Tapping it navigates to the user profile view.")
