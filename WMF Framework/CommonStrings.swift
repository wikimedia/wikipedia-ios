...
public class CommonStrings: NSObject {
    ...
    public static let editorWikitextTextviewAccessibilityLabel = WMFLocalizedString("editor-wikitext-textview-accessibility", value: "Wikitext editor", comment: "Accessibility label for the wikitext editor textview.")
