...
public class CommonStrings: NSObject {
    ...
    @objc public static let nearbyFooterTitle = WMFLocalizedString("home-nearby-footer", value: "More from nearby your location", comment: "Footer for presenting user option to see longer list of nearby articles.")
