...
public class CommonStrings: NSObject {
    ...
    static let addedTextDescription = WMFLocalizedString("aaald-added-text-description", value:"%@ added", comment:"Title displayed in an article as a living document cell explaining that a revision has a certain number of characters added. %@ is replaced by a formatted string representing characters added.")
    
    static let deletedTextDescription = WMFLocalizedString("aaald-deleted-text-description", value:"%@ deleted", comment:"Title displayed in an article as a living document cell explaining that a revision has a certain number of characters deleted. %@ is replaced by a formatted string representing characters deleted.")
