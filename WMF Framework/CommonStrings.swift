...
public extension CommonStrings {
    ...
    static let editorInputViewHeaderTypeHeading = WMFLocalizedString("edit-text-header-heading", value: "Heading", comment: "Title for button that changes text header type to heading.")
    static let editorInputViewHeaderTypeSubhead1 = WMFLocalizedString("edit-text-header-subheading1", value: "Sub-heading 1", comment: "Title for button that changes text header type to subheading 1.")
    static let editorInputViewHeaderTypeSubhead2 = WMFLocalizedString("edit-text-header-subheading2", value: "Sub-heading 2", comment: "Title for button that changes text header type to subheading 2.")
    static let editorInputViewHeaderTypeSubhead3 = WMFLocalizedString("edit-text-header-subheading3", value: "Sub-heading 3", comment: "Title for button that changes text header type to subheading 3.")
    static let editorInputViewHeaderTypeSubhead4 = WMFLocalizedString("edit-text-header-subheading4", value: "Sub-heading 4", comment: "Title for button that changes text header type to subheading 4.")
}
