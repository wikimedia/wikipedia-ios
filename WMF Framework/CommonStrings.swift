...
public class CommonStrings: NSObject {
    ...
    public static let lockscreenSearchWidgetTitle = WMFLocalizedString("lockscreen-search-widget-title", value: "Search", comment: "Text for title of lockscreen search widget.")
