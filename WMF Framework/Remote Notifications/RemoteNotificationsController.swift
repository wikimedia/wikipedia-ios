...
@objc public final class RemoteNotificationsController: NSObject {
    ...
    @objc public func updateCacheWithCurrentUnreadNotificationsCount() throws {
        ...
        let sharedCache = SharedContainerCache<PushNotificationsCache>(fileName: "Push Notifications Cache", defaultCache: { PushNotificationsCache(settings: .default, notifications: []) })
