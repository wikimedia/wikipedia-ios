...
@objc public final class RemoteNotificationsController: NSObject {
    ...
    @objc public func updateCacheWithCurrentUnreadNotificationsCount() throws {
        ...
        let sharedCache = SharedContainerCache<PushNotificationsCache>(fileName: SharedContainerCacheCommonFileNames.pushNotificationsCache, defaultCache: { PushNotificationsCache(settings: .default, notifications: []) })
