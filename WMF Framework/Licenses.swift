...
@objcMembers public class Licenses: NSObject {
    public static let localizedCCBYSA3Title = WMFLocalizedString("cc-by-sa-3.0", value: "CC BY-SA 3.0", comment: "Name of the CC BY-SA 3.0 license - https://creativecommons.org/licenses/by-sa/3.0/")
    ...
    public static let localizedGFDLTitle = WMFLocalizedString("gfdl", value: "GFDL", comment: "Name of the GFDL license - https://www.gnu.org/licenses/fdl.html")
