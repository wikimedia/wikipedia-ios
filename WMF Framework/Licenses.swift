...
public class Licenses: NSObject {
    ...
    @objc static let localizedGDFLTitle = WMFLocalizedString("gdfl", value: "GDFL", comment: "Name of the GDFL license - https://www.gnu.org/licenses/fdl.html")
    ...
    @objc static let GDFLURL = URL(string: "https://www.gnu.org/licenses/fdl.html")
