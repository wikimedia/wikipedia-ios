...
public class NavigationBar: SetupView, FakeProgressReceiving, FakeProgressDelegate {
    ...
    fileprivate let titleBar: UIToolbar = UIToolbar(frame: CGRect.init(x: 0, y: 0, width: Int.max, height: Int.max)) // HAX: 'Int.max' is workaround for iOS 13 constraint breakage warnings
