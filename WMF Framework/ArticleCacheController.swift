...
public final class ArticleCacheController: CacheController {
    ...
    init(moc: NSManagedObjectContext, imageCacheController: ImageCacheController, session: Session, configuration: Configuration, preferredLanguageDelegate: WMFPreferredCodesProviding) {
