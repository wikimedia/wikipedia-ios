...
@objc public extension UIView {
    ...
    @objc func wmf_addHeightDeterminingSubviewWithConstraintsToEdges(_ subview: UIView) {
        wmf_addHeightDeterminingSubview(subview, withConstraintsToEdgesWithInsets: .zero)
    }
    
    @objc func wmf_addHeightDeterminingSubview(_ subview: UIView, withConstraintsToEdgesWithInsets insets: UIEdgeInsets, priority: UILayoutPriority = .required) {
    ...
    @objc func wmf_addSubview(_ subview: UIView, withConstraintsToEdgesWithInsets insets: UIEdgeInsets, priority: UILayoutPriority = .required) {
        addSubview(subview)
