...
extension String {
    public func byAttributingHTML(with textStyle: DynamicTextStyle, matching traitCollection: UITraitCollection, withBoldedString: String? = nil, underlineColor: UIColor? = nil) -> NSMutableAttributedString {
