...
extension String {
    public func byAttributingHTML(with textStyle: DynamicTextStyle, matching traitCollection: UITraitCollection) -> NSAttributedString {
        ...
        return (self as NSString).wmf_attributedStringFromHTML(with: font, boldFont: boldFont, italicFont: italicFont, boldItalicFont: boldItalicFont, withAdditionalBoldingForMatchingSubstring: nil)
    }
}
