...
extension String {
    public func byAttributingHTML(with textStyle: DynamicTextStyle, boldWeight: UIFont.Weight = .semibold, matching traitCollection: UITraitCollection, withBoldedString: String? = nil, color: UIColor? = nil, linkColor: UIColor? = nil, tagMapping: [String: String]? = nil, additionalTagAttributes: [String: [NSAttributedString.Key: Any]]? = nil) -> NSMutableAttributedString {
        ...
        return (self as NSString).wmf_attributedStringFromHTML(with: font, boldFont: boldFont, italicFont: italicFont, boldItalicFont: boldItalicFont, color: color, linkColor: linkColor, withAdditionalBoldingForMatchingSubstring: withBoldedString, tagMapping: tagMapping, additionalTagAttributes: additionalTagAttributes)
    }
}
