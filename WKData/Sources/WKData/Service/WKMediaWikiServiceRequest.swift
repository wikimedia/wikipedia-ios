...
public struct WKMediaWikiServiceRequest: WKServiceRequest {
    ...
    internal init(url: URL? = nil, method: WKServiceRequestMethod, languageVariantCode: String? = nil, tokenType: WKMediaWikiServiceRequest.TokenType? = nil, parameters: [String : Any]? = nil) {
        self.url = url
        self.method = method
