...
class WMFInTheNewsNotificationViewController: UIViewController, UNNotificationContentExtension, WMFAnalyticsContextProviding, WMFAnalyticsContentTypeProviding {
    ...
    func didReceive(_ notification: UNNotification) {
        ...
        timeLabel.text = NSLocalizedString("in-the-news-currently-trending", value:"Currently trending", comment: "Currently trending - indicates that the story is trending right now")
    ...
    func didReceive(_ response: UNNotificationResponse, completionHandler completion: @escaping (UNNotificationContentExtensionResponseOption) -> Void) {
        ...
        case WMFInTheNewsNotificationSaveForLaterActionIdentifier:
            ...
            statusLabel.text = NSLocalizedString("status-saving-for-later", value:"Saving for later...", comment: "Indicates to the user that the article is being saved for later")
            ...
            if let dataStore = SessionSingleton.sharedInstance().dataStore {
                ...
                self.statusLabel.text = NSLocalizedString("status-saved-for-later", value:"Saved for later", comment: "Indicates to the user that the article has been saved for later")
                completion(.dismiss)
            } else {
                completion(.dismiss)
                break
