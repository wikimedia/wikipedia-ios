    ...
    func didReceive(_ notification: UNNotification) {
        ...
        do {
            if let dictionary = info[WMFNotificationInfoFeedNewsStoryKey] as? [String: AnyObject],
                ...
                let attributedString = html.wmf_attributedStringFromHTML(with: font, boldFont: linkFont, italicFont: font, boldItalicFont: linkFont, color: nil, linkColor: nil, handlingLists: false, handlingSuperSubscripts: false, withAdditionalBoldingForMatchingSubstring: nil, tagMapping: ["a":"b"], additionalTagAttributes: nil, baseURL: nil)
