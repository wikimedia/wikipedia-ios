...
class NotificationService: UNNotificationServiceExtension {
    ...
    private let sharedCache = SharedContainerCache<PushNotificationsCache>.init(fileName: "Push Notifications Cache", defaultCache: { PushNotificationsCache(settings: .default, notifications: []) })
