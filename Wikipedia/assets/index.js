...
class Footer {
  ...
  constructor(articleTitle, menuItems, hasReadMore, readMoreItemCount, localizedStrings, appSchemeURL) {
  ...
  addReadMore() {
    if (this.hasReadMore){
      ...
      requirements.footerReadMore.add(this.articleTitle, this.readMoreItemCount, 'pagelib_footer_container_readmore_pages', this.appSchemeURL, saveButtonTapHandler, titlesShownHandler, document)
    }
  }
  addLegal() {
