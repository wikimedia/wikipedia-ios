...
window.wmf = wmf
},{"./js/editTextSelection":3,"./js/elementLocation":4,"./js/findInPage":5,"./js/footers":6,"./js/sections":7,"./js/utilities":8,"./js/windowResizeScroll":9,"wikimedia-page-library":10}],2:[function(require,module,exports){
...
},{"./utilities":8,"wikimedia-page-library":10}],3:[function(require,module,exports){
const utilities = require('./utilities')
...
exports.getIndexOfFirstOnScreenElement = (elementPrefix, elementCount, insetTop) => {
  for (let i = 0; i < elementCount; ++i) {
    ...
    if (rect.Y >= -1 || rect.Y + rect.Height >= insetTop) {
      return i
    }
  }
  return -1
...
},{"wikimedia-page-library":10}],7:[function(require,module,exports){
...
},{"./elementLocation":4,"./utilities":8,"wikimedia-page-library":10}],8:[function(require,module,exports){
