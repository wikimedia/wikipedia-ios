...
class WMFForgotPasswordViewController: WMFScrollViewController {
    ...
    override func viewDidLoad() {
        ...
        titleLabel.text = NSLocalizedString("forgot-password-title", value:"Reset password", comment:"Title for reset password interface\n{{Identical|Reset password}}")
        subTitleLabel.text = NSLocalizedString("forgot-password-instructions", value:"Fill in one of the fields below to receive password reset instructions via email", comment:"Instructions for resetting password")
        ...
        emailTitleLabel.text = NSLocalizedString("field-email-title", value:"Email", comment:"Noun. Title for email address field.\n{{Identical|E-mail}}")
        resetPasswordButton.setTitle(NSLocalizedString("forgot-password-button-title", value:"Reset", comment:"Title for reset password button\n{{Identical|Reset}}"), for: .normal)
        orLabel.text = NSLocalizedString("forgot-password-username-or-email-title", value:"Or", comment:"Title shown between the username and email text fields. User only has to specify either username \"Or\" email address\n{{Identical|Or}}")
        ...
        tokenFetcher.fetchToken(ofType: .csrf, siteURL: siteURL, success: { tokenBlock in
            self.passwordResetter.resetPassword(
                ...
                success: { result in
                    ...
                    WMFAlertManager.sharedInstance.showSuccessAlert(NSLocalizedString("forgot-password-email-sent", value:"An email with password reset instructions was sent", comment:"Alert text shown when password reset email is sent"), sticky: true, dismissPreviousAlerts: true, tapCallBack: nil)
            }, failure:failure)
        }, failure:failure)
    }
}
