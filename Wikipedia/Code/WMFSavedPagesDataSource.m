  ...
  if (self) {
    ...
    [self.KVOController
        ...
        options:NSKeyValueObservingOptionInitial |
          ...
          block:^(WMFSavedPagesDataSource *observer, MWKSavedPageList *object,
                  NSDictionary *change) {
            BOOL isPrior =
...
- (MWKSavedPageEntry *)savedPageForIndexPath:(NSIndexPath *)indexPath {
  MWKSavedPageEntry *savedEntry =
      [self.savedPageList entryAtIndex:indexPath.row];
  return savedEntry;
}
