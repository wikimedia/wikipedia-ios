...
#else
                NSString *errorMessage = WMFLocalizedStringWithDefaultValue(@"article-unable-to-load-article", nil, NSBundle.wmf_localizationBundle, @"Unable to load article.", @"Alert text shown when unable to load an article");
