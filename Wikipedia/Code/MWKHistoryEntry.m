...
- (instancetype)initWithDict:(NSDictionary *)dict {
  ...
  if (self) {
    ...
    self.scrollPosition =
        [[self requiredNumber:@"scrollPosition" dict:dict] floatValue];
    self.titleWasSignificantlyViewed =
        [[self optionalNumber:@"titleWasSignificantlyViewed" dict:dict]
            boolValue];
  }
  return self;
}
...
- (NSString *)description {
  return [NSString stringWithFormat:@"%@: {\n"
                                     ...
                                     "\tscrollPosition: %f\n"
                                     "}",
                                    [super description], self.url.description,
                                    self.date, self.scrollPosition];
}
...
- (id)dataExport {
  ...
  [dict wmf_maybeSetObject:@(self.titleWasSignificantlyViewed)
                    forKey:@"titleWasSignificantlyViewed"];
