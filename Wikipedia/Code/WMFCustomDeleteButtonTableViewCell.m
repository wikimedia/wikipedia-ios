...
- (UIButton *)wmf_deleteButton {
  ...
  [button setImage:[UIImage imageNamed:@"language-delete"]
...
// HAX: need white layer beneath the custom minus button to hide the baked-in
// minus button.
// Used layer because this is immune to cell drag forcing background colors set
// otherwise to
// go transparent on drag. Also needed to do same for entire cell otherwise it
// looks weird on
