...
CGRect WMFDenormalizeRectUsingSize(CGRect rect, CGSize size) {
  ...
  return CGRectApplyAffineTransform(rect,
                                    WMFAffineDenormalizeTransformMake(size));
}
...
CGRect WMFConvertCGCoordinateRectToUICoordinateRectUsingSize(CGRect cgRect,
                                                             CGSize size) {
  return CGRectApplyAffineTransform(
      cgRect, WMFAffineCoreGraphicsToUIKitTransformMake(size));
}

CGRect WMFConvertUICoordinateRectToCGCoordinateRectUsingSize(CGRect uiRect,
                                                             CGSize size) {
  return CGRectApplyAffineTransform(
      uiRect, WMFAffineUIKitToCoreGraphicsTransformMake(size));
}
...
CGAffineTransform WMFAffineUIKitToCoreGraphicsTransformMake(CGSize size) {
  return CGAffineTransformInvert(
      WMFAffineCoreGraphicsToUIKitTransformMake(size));
}
