...
static MWKImageInfoResolve addPictureOfTheDayToDescriptionForDate(NSDate *date) {
    return ^id(MWKImageInfo *info) {
        ...
        [[NSString localizedStringWithFormat:NSLocalizedStringWithDefaultValue(@"potd-description-prefix", nil, NSBundle.wmf_localizationBundle, @"Picture of the day for %1$@", "Prefix to picture of the day description which states it was the picture of the day for a specific date. The %1$@ token is subtituted for the date."), dateString] mutableCopy];
