...
- (NSUInteger)wmf_startingIndexForApplicationLayoutDirection {
  return [self
      wmf_startingIndexForLayoutDirection:[[UIApplication sharedApplication]
...
- (instancetype)wmf_reverseArrayIfApplicationIsRTL {
  return [self wmf_reverseArrayIfRTL:[[UIApplication sharedApplication]
                                         userInterfaceLayoutDirection]];
}
