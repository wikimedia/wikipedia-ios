...
- (void)displayArticle {
    ...
    UIMenuItem *shareSnippet = [[UIMenuItem alloc] initWithTitle:NSLocalizedStringWithDefaultValue(@"share-a-fact-share-menu-item", nil, NSBundle.wmf_localizationBundle, @"Share-a-fact", "Button label for creating a Share-a-fact card from the current text selection")
