...
final class DiffHeaderViewModel: Themeable {
    ...
    init?(diffType: DiffContainerViewModel.DiffType, fromModel: WMFPageHistoryRevision?, toModel: WMFPageHistoryRevision, articleTitle: String, imageURL: URL?, byteDifference: Int?, theme: Theme) {
