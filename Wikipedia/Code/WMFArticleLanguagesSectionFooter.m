...
- (void)awakeFromNib {
    ...
    [self.addButton setTitle:NSLocalizedStringWithDefaultValue(@"welcome-languages-add-button", nil, NSBundle.wmf_localizationBundle, @"Add another language", "Title for button for adding another language")
