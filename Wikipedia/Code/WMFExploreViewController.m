...
- (void)awakeFromNib {
    [super awakeFromNib];
    self.title = NSLocalizedStringWithDefaultValue(@"home-title", nil, NSBundle.wmf_localizationBundle, @"Explore", "Title for home interface.\n{{Identical|Explore}}");
...
- (nullable UIAlertController *)menuActionSheetForSection:(WMFContentGroup *)section {
    switch (section.contentGroupKind) {
        case WMFContentGroupKindRelatedPages: {
            ...
            [sheet addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"home-hide-suggestion-prompt", nil, NSBundle.wmf_localizationBundle, @"Hide this suggestion", "Title of button shown for users to confirm the hiding of a suggestion in the explore feed")
            ...
            [sheet addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"home-hide-suggestion-cancel", nil, NSBundle.wmf_localizationBundle, @"Cancel", "Title of the button for cancelling the hiding of an explore feed suggestion\n{{Identical|Cancel}}") style:UIAlertActionStyleCancel handler:NULL]];
            return sheet;
        }
        case WMFContentGroupKindLocationPlaceholder: {
            UIAlertController *sheet = [UIAlertController alertControllerWithTitle:nil message:nil preferredStyle:UIAlertControllerStyleActionSheet];
            [sheet addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"explore-nearby-placeholder-dismiss", nil, NSBundle.wmf_localizationBundle, @"Dismiss", "Action button that will dismiss the nearby placeholder\n{{Identical|Dismiss}}")
                                                      style:UIAlertActionStyleDestructive
                                                    handler:^(UIAlertAction *_Nonnull action) {
            ...
            [sheet addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"explore-nearby-placeholder-cancel", nil, NSBundle.wmf_localizationBundle, @"Cancel", "Action button that will cancel dismissal of the nearby placeholder\n{{Identical|Cancel}}") style:UIAlertActionStyleCancel handler:NULL]];
            return sheet;
        }
        default:
            return nil;
