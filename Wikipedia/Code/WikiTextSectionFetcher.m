        ...
        success:^(NSURLSessionDataTask *operation, id responseObject) {
            ...
            if (!error) {
                ...
                if (![output objectForKey:@"revision"] || ![output objectForKey:@"userInfo"]) {
                    ...
                    errorDict[NSLocalizedDescriptionKey] = NSLocalizedStringWithDefaultValue(@"wikitext-download-failed", nil, NSBundle.wmf_localizationBundle, @"Unable to obtain latest revision.", "Alert text shown when unable to obtain latest revision of the section being edited");
