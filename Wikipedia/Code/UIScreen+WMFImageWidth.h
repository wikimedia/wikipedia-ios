 ...
 *
 *  @return The thumbnail width to request for article list cells, according to
 * the receiver's @c scale.
 */
 ...
 *
 *  @return The thumbnail width to request for nearby cells, according to the
 * receiver's @c scale.
 */
 ...
 *
 *  @return The thumbnail width to request for POTD cells, according ot the
 * receiver's @c scale.
 */
 ...
 *
 *  @return The thumbnail width to request for the modal image gallery,
 * according to the receiver's @c scale.
 */
- (NSNumber *)wmf_galleryImageWidthForScale;

/**
 *  @return The thumbnail width to request for the article, according to the
 * receiver's @c scale.
 */
