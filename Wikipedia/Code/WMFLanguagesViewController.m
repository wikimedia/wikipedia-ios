...
+ (instancetype)languagesViewController {
    ...
    languagesVC.title = NSLocalizedStringWithDefaultValue(@"article-languages-label", nil, NSBundle.wmf_localizationBundle, @"Choose language", "Header label for per-article language selector screen.\n{{Identical|Choose language}}");
...
+ (instancetype)nonPreferredLanguagesViewController {
    ...
    languagesVC.title = NSLocalizedStringWithDefaultValue(@"settings-my-languages", nil, NSBundle.wmf_localizationBundle, @"My languages", "Title for list of user's preferred languages");
    languagesVC.editing = NO;
...
- (void)viewDidLoad {
    ...
    self.languageFilterField.placeholder = NSLocalizedStringWithDefaultValue(@"article-languages-filter-placeholder", nil, NSBundle.wmf_localizationBundle, @"Find language", "Filter languages text box placeholder text.");
...
- (NSString *)titleForHeaderInSection:(NSInteger)section {
    NSString *title = ([self isPreferredSection:section]) ? NSLocalizedStringWithDefaultValue(@"article-languages-yours", nil, NSBundle.wmf_localizationBundle, @"Your languages", "Title for list of user's preferred languages") : NSLocalizedStringWithDefaultValue(@"article-languages-others", nil, NSBundle.wmf_localizationBundle, @"Other languages", "Title for list of languages not in user's preferred languages");
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    if ([self shouldShowFooterForSection:section]) {
        ...
        footer.title = NSLocalizedStringWithDefaultValue(@"settings-primary-language-details", nil, NSBundle.wmf_localizationBundle, @"The first language in this list is used as the primary language for the app. Changing this language will change daily content (such as Featured Article) shown on Explore.", "Explanation of how the first preferred language is used. \"Explore\" is {{msg-wm|Wikipedia-ios-home-title}}.");
        return footer;
    } else {
        return nil;
    }
...
+ (instancetype)articleLanguagesViewControllerWithArticleURL:(NSURL *)url {
    ...
    languagesVC.editing = NO;
    languagesVC.title = NSLocalizedStringWithDefaultValue(@"languages-title", nil, NSBundle.wmf_localizationBundle, @"Change language", "Title for language picker\n{{Identical|Language}}");
