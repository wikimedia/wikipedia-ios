...
- (NSArray<NSDate *> *)wmf_datesUntilDate:(NSDate *)date {
  ...
  NSTimeInterval const secondsUntilDate =
      [laterDate timeIntervalSinceDate:earlierDate];
  NSInteger const daysUntilDate =
      floorf(secondsUntilDate / (NSTimeInterval)D_DAY);
