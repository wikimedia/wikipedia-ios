...
/**
 * Present the share options with the specified snippet, in the given
 * viewcontroller, from the given button item.
 *
 * @param snippet           The snippet to share.
 * @param viewController    The view controller that will present the menus.
 * @param item              The item that will serve as the origin for the menu
 * (i.e. a popover arrow).
 *
