...
/**
 *  An array of view controllers which will be displayed above the receiver's @c
 * UIWebView content from top to bottom.
 *
 *  Setting this property with an array containing the same view controllers in
 * the same order has no effect.
 */
...
- (void)webViewController:(WebViewController *)controller
    didTapImageWithSourceURL:(NSURL *)imageSourceURL;
- (void)webViewController:(WebViewController *)controller
