...
+ (instancetype)noFeedEmptyView {
  ...
  view.actionLabel.text =
      MWLocalizedString(@"empty-no-feed-action-message", nil);
...
+ (instancetype)noSearchResultsEmptyView {
  ...
  view.messageLabel.text =
      MWLocalizedString(@"empty-no-search-results-message", nil);
...
+ (instancetype)noSavedPagesEmptyView {
  ...
  view.messageLabel.text =
      MWLocalizedString(@"empty-no-saved-pages-message", nil);
...
- (void)layoutSubviews {
  ...
  // draw a line
  [path moveToPoint:CGPointMake(CGRectGetMidX(self.actionLine.bounds),
                                CGRectGetMinY(self.actionLine.bounds))];
  [path addLineToPoint:CGPointMake(CGRectGetMidX(self.actionLine.bounds),
                                   CGRectGetMaxY(self.actionLine.bounds))];
  [path stroke];
