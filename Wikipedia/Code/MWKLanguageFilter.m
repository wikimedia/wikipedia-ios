...
- (instancetype)initWithLanguageDataSource:(id<MWKLanguageFilterDataSource>)dataSource {
    ...
    if (self) {
        ...
        [self.KVOController observe:dataSource keyPath:WMF_SAFE_KEYPATH(dataSource, allLanguages) options:0 block:^(MWKLanguageFilter* observer, id object, NSDictionary* change) {
