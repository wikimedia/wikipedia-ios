...
- (void)wmf_showAlertForTappedAnchorHref:(NSString *)href {
    ...
    [alertController addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"button-ok", nil, NSBundle.wmf_localizationBundle, @"OK", "Button text for ok button used in various places\n{{Identical|OK}}")
...
- (void)viewDidLoad {
    ...
    self.buttonSave = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedStringWithDefaultValue(@"button-publish", nil, NSBundle.wmf_localizationBundle, @"Publish", "Button text for publish button used in various places.\n{{Identical|Publish}}") style:UIBarButtonItemStylePlain target:self action:@selector(goForward)];
    ...
    self.previewLabel.text = NSLocalizedStringWithDefaultValue(@"navbar-title-mode-edit-wikitext-preview", nil, NSBundle.wmf_localizationBundle, @"Preview", "Header text shown when wikitext changes are being previewed.\n{{Identical|Preview}}");
...
- (void)setupEditSummaryContainerSubviews {
    ...
    self.cannedSummary01 = setupButton(NSLocalizedStringWithDefaultValue(@"edit-summary-choice-fixed-typos", nil, NSBundle.wmf_localizationBundle, @"Fixed typo", "Button text for quick 'fixed typos' edit summary selection"), CANNED_SUMMARY_TYPOS);
    self.cannedSummary02 = setupButton(NSLocalizedStringWithDefaultValue(@"edit-summary-choice-fixed-grammar", nil, NSBundle.wmf_localizationBundle, @"Fixed grammar", "Button text for quick 'improved grammar' edit summary selection"), CANNED_SUMMARY_GRAMMAR);
    self.cannedSummary03 = setupButton(NSLocalizedStringWithDefaultValue(@"edit-summary-choice-linked-words", nil, NSBundle.wmf_localizationBundle, @"Added links", "Button text for quick 'link addition' edit summary selection"), CANNED_SUMMARY_LINKS);
    self.cannedSummary04 = setupButton(NSLocalizedStringWithDefaultValue(@"edit-summary-choice-other", nil, NSBundle.wmf_localizationBundle, @"Other", "Button text for quick \"other\" edit summary selection.\n{{Identical|Other}}"), CANNED_SUMMARY_OTHER);
    ...
    self.aboutLabel.text = NSLocalizedStringWithDefaultValue(@"edit-summary-title", nil, NSBundle.wmf_localizationBundle, @"How did you improve the article?", "Title for edit summary area of the preview page");
...
- (void)preview {
    [[WMFAlertManager sharedInstance] showAlert:NSLocalizedStringWithDefaultValue(@"wikitext-preview-changes", nil, NSBundle.wmf_localizationBundle, @"Retrieving preview of your changes...", "Alert text shown when getting preview of user changes to wikitext") sticky:YES dismissPreviousAlerts:YES tapCallBack:NULL];
...
- (void)save {
    ...
    [[WMFAlertManager sharedInstance] showAlert:NSLocalizedStringWithDefaultValue(@"wikitext-upload-save", nil, NSBundle.wmf_localizationBundle, @"Publishing...", "Alert text shown when changes to section wikitext are being published\n{{Identical|Publishing}}") sticky:YES dismissPreviousAlerts:YES tapCallBack:NULL];
...
- (void)previewLicenseViewTermsLicenseLabelWasTapped:(PreviewLicenseView *)previewLicenseview {
    ...
    [sheet addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"wikitext-upload-save-terms-name", nil, NSBundle.wmf_localizationBundle, @"Terms of Use", "This message is used in the message [[Wikimedia:Wikipedia-ios-wikitext-upload-save-terms-and-license]].\n{{Identical|Terms of use}}")
                                              style:UIAlertActionStyleDefault
                                            handler:^(UIAlertAction *_Nonnull action) {
                                                [self wmf_openExternalUrl:[NSURL URLWithString:TERMS_LINK]];
                                            }]];
    [sheet addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"wikitext-upload-save-license-name", nil, NSBundle.wmf_localizationBundle, @"CC BY-SA 3.0", "Name of license user edits are saved under - presently CC BY-SA 3.0\n{{Identical|CC BY-SA}}")
                                              style:UIAlertActionStyleDefault
                                            handler:^(UIAlertAction *_Nonnull action) {
                                                [self wmf_openExternalUrl:[NSURL URLWithString:LICENSE_LINK]];
                                            }]];
    [sheet addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"open-link-cancel", nil, NSBundle.wmf_localizationBundle, @"Cancel", "Text for cancel button in popup menu of terms/license link options\n{{Identical|Cancel}}") style:UIAlertActionStyleCancel handler:NULL]];
