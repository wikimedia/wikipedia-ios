...
- (void)viewDidLoad {
  [super viewDidLoad];
  self.welcomeNavigationController.interactivePopGestureRecognizer.delegate =
      self;
}
...
+ (instancetype)welcomeViewControllerFromDefaultStoryBoard {
  return [[UIStoryboard storyboardWithName:@"WMFWelcome" bundle:nil]
...
animationControllerForOperation:(UINavigationControllerOperation)operation
  ...
  WMFBoringNavigationTransition *animation =
      [[WMFBoringNavigationTransition alloc] init];
