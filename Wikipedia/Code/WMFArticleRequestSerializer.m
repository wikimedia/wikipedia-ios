...
- (NSURLRequest *)requestBySerializingRequest:(NSURLRequest *)request
  ...
  NSMutableDictionary *serializedParams =
      [self paramsForURL:(NSURL *)parameters];
...
- (NSMutableDictionary *)paramsForURL:(NSURL *)url {
  NSMutableDictionary *params = @{
    ...
    @"sectionprop" : WMFJoinedPropertyParameters(@[
      @"toclevel", @"line", @"anchor", @"level", @"number", @"fromtitle",
      @"index"
    ]),
    @"noheadings" : @"true",
    @"sections" : @"all",
    ...
    @"prop" : WMFJoinedPropertyParameters(@[
      @"sections", @"text", @"lastmodified", @"lastmodifiedby",
