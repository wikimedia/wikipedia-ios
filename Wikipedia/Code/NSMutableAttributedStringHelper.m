...
@property (strong, nonatomic) NSString *templateRegexStr;
...
@property (strong, nonatomic) NSRegularExpression *templateRegex;
...
-(instancetype)initWithTheme:(WMFTheme *)theme {
    ...
    if (self) {
        ...
        _templateRegex = [NSRegularExpression regularExpressionWithPattern:_templateRegexStr options:0 error:nil];
...
-(void)addWikitextSyntaxFormattingToNSMutableAttributedString: (NSMutableAttributedString *)mutAttributedString searchRange: (NSRange)searchRange fontSizeTraitCollection: (UITraitCollection *)fontSizeTraitCollection needsColors: (BOOL)needsColors theme: (WMFTheme *)theme {
    ...
    [self.templateRegex enumerateMatchesInString:mutAttributedString.string
                                    options:0
                                      range:searchRange
                                 usingBlock:^(NSTextCheckingResult *_Nullable result, NSMatchingFlags flags, BOOL *_Nonnull stop) {
                                     NSRange matchRange = [result rangeAtIndex:0];
