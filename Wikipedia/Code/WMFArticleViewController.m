    ...
    self.articleFetcherPromise = [self.articleFetcher fetchLatestVersionOfArticleWithURL:self.articleURL
        ...
        failure:^(NSError *_Nonnull error) {
            ...
            if (cachedFallback) {
                ...
                [[NSNotificationCenter defaultCenter] postNotificationName:WMFNavigateToActivityNotification object:[NSUserActivity wmf_specialPagesActivityWithURL:self.articleURL]];
