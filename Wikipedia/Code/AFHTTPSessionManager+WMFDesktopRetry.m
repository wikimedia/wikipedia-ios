...
wmf_GETWithMobileURLString:(NSString *)mobileURLString
  ...
  if (isZeroRated) {
    return [self GET:mobileURLString
        ...
        progress:NULL
        success:^(NSURLSessionDataTask *_Nonnull operation,
                  id _Nonnull responseObject) {
          if (success) {
            success(operation, responseObject);
          }
        }
        failure:^(NSURLSessionDataTask *_Nonnull operation,
...
wmf_GETAndRetryWithURL:(NSURL *)URL
            parameters:(id)parameters
               ...
               failure:(void (^)(NSURLSessionDataTask *operation,
                                 NSError *error))failure {
  return [self wmf_GETWithMobileURLString:[NSURL wmf_mobileAPIURLForURL:URL]
                                              .absoluteString
                         desktopURLString:[NSURL wmf_desktopAPIURLForURL:URL]
                                              .absoluteString
                               parameters:parameters
                                    retry:retry
                                  success:success
