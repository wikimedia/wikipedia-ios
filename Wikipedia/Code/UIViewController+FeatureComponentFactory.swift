...
extension WMFImageRecommendationsViewController {
    static func imageRecommendationsViewController(dataStore: MWKDataStore, imageRecDelegate: WMFImageRecommendationsDelegate?, imageRecLoggingDelegate: WMFImageRecommendationsLoggingDelegate?) -> WMFImageRecommendationsViewController? {
        ...
        let tooltipStrings = WMFImageRecommendationsViewModel.LocalizedStrings.TooltipStrings(
            tooltip1Title: WMFLocalizedString("image-rec-tooltip-1-title", value: "Review", comment: "Title of first tooltip displayed when landing on image recommendations feature for the first time."), tooltip1Body: WMFLocalizedString("image-rec-tooltip-1-body", value: "Review this article to understand its topic.", comment: "Body of first tooltip displayed when landing on image recommendations feature for the first time."), tooltip2Title: WMFLocalizedString("image-rec-tooltip-2-title", value: "Inspect", comment: "Title of second tooltip displayed when landing on image recommendations feature for the first time."), tooltip2Body: WMFLocalizedString("image-rec-tooltip-2-body", value: "Inspect the image and its associated information.", comment: "Body of second tooltip displayed when landing on image recommendations feature for the first time."), tooltip3Title: WMFLocalizedString("image-rec-tooltip-3-title", value: "Decide", comment: "Title of second tooltip displayed when landing on image recommendations feature for the first time."), tooltip3Body: WMFLocalizedString("image-rec-tooltip-3-body", value: "Decide if the image helps readers understand this topic better.", comment: "Body of second tooltip displayed when landing on image recommendations feature for the first time."))
        ...
        let localizedStrings = WMFImageRecommendationsViewModel.LocalizedStrings(title: CommonStrings.addImageTitle, viewArticle: CommonStrings.viewArticle, onboardingStrings: onboardingStrings, tooltipStrings: tooltipStrings, surveyLocalizedStrings: surveyLocalizedStrings, emptyLocalizedStrings: emptyStrings, errorLocalizedStrings: errorStrings, bottomSheetTitle: CommonStrings.bottomSheetTitle, yesButtonTitle: CommonStrings.yesButtonTitle, noButtonTitle: CommonStrings.noButtonTitle, notSureButtonTitle: CommonStrings.notSureButtonTitle, learnMoreButtonTitle: CommonStrings.learnMoreTitle(), tutorialButtonTitle: CommonStrings.tutorialTitle, problemWithFeatureButtonTitle: CommonStrings.problemWithFeatureTitle)
