 ...
 *
 * @warning Do not attempt to parse raw timestamps from the mediawiki API using
 * this method. Use the unstyled
 *          @c +wmf_iso8601Formatter method instead.
 *
 * @note    This method is not thread safe, as it is intended to only be used by
 * code which presents text to the user.
 *
