...
#if WMF_DEPRECATE_BELOW_DEPLOY_TARGET &&                                       \
    __IPHONE_OS_VERSION_MIN_REQUIRED >= __IPHONE_9_0
#define WMF_DEPRECATED_WHEN_DEPLOY_AT_LEAST_9                                  \
  __deprecated_msg("This API was only necessary when deployment target was < " \
                   "9. Please remove any code being executed when OS is less " \
                   "than 9.")
#else
#define WMF_DEPRECATED_WHEN_DEPLOY_AT_LEAST_9
#endif
