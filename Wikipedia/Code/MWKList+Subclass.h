...
/**
 *  Invoked during @c initWithEntries: to set the receiver's internal @c entries
 * to the given objects.
 *
 *  Override this method to perform any preprocessing on the entries before
 * they're set.  Your implementation should
...
/**
 *  Update the entry associated with @c listIndex, updating the internal @c
 * dirty flag if necessary.
 *
 ...
 */
- (void)updateEntryWithListIndex:(MWKListIndex)listIndex
                          update:(MWKListUpdateBlock)update;

/**
 *  Insert @c entry at the given index.
 *
 *  @param entry The entry to insert.
 *  @param index The index in the list to insert it, will raise an exception if
 * out of bounds.
 */
