...
/**
 *  Casts the receiver's value to a @c MWKTitleNamespace enum, performing
 * additional range validation.
 *
 *  @return The receiver's integer value as a namespace enum, or if out of
 * bounds, @c MWKTitleNamespaceUnknown.
 */
 ...
 *
 *  @return @c YES if the receiver's integer value is @c MWKTitleNamespaceMain,
 * otherwise @c NO.
 */
