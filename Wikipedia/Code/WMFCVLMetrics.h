...
/*!
 @class        WMFCVLMetrics
 @abstract     WMFCVLMetrics represent the metrics used for a
 WMFColumnarCollectionViewLayout. The attributes of this object are for
 customizing the associated WMFColumnarCollectionViewLayout.
 @discussion   ...
 */
