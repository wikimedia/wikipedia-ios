...
extension PageEditorViewController {
    ...
    static let clearFortmatting = WMFLocalizedString("source-editor-clear-formatting", value: "Clear formatting", comment: "Label for clear formatting on the page editor")
    ...
    static let accessibilityLabelButtonFormaHeading = WMFLocalizedString("source-editor-accessibility-label-format-heading", value: "Show text style menu", comment: "Accessibility label for heading style formatting menu button on the page editor")
    ...
    static let accessibilityLabelButtonInceaseIndent = WMFLocalizedString("source-editor-accessibility-label-indent-increase", value: "Increase indent depth", comment: "Accessibility label for the increase indent button on the page editor")
