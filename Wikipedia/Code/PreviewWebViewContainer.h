...
@property(weak, nonatomic) id<WMFOpenExternalLinkDelegate>
    externalLinksOpenerDelegate;
@property(strong, nonatomic) WKWebView *webView;

@property(weak, nonatomic) IBOutlet id<WMFPreviewSectionLanguageInfoDelegate>
    previewSectionLanguageInfoDelegate;
@property(weak, nonatomic) IBOutlet id<WMFPreviewAnchorTapAlertDelegate>
    previewAnchorTapAlertDelegate;
