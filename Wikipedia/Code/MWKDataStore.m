...
- (instancetype)initWithContainerURL:(NSURL *)containerURL {
    ...
    if (self) {
        ...
        self.remoteNotificationsController = [[RemoteNotificationsController alloc] initWithSession:session configuration:configuration languageLinkController:self.languageLinkController];
