...
- (instancetype)initWithContainerURL:(NSURL *)containerURL {
    ...
    if (self) {
        ...
        self.notificationsController = [[WMFNotificationsController alloc] initWithDataStore:self languageLinkController:self.languageLinkController authenticationManager:self.authenticationManager];
