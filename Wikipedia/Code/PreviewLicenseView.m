...
- (void)styleLinks:(UILabel *)label {
    ...
    label.attributedText =
        [label.text attributedStringWithAttributes:baseAttributes
                               substitutionStrings:@[NSLocalizedStringWithDefaultValue(@"wikitext-upload-save-terms-name", nil, NSBundle.wmf_localizationBundle, @"Terms of Use", "This message is used in the message [[Wikimedia:Wikipedia-ios-wikitext-upload-save-terms-and-license]].\n{{Identical|Terms of use}}"),
                                                     NSLocalizedStringWithDefaultValue(@"wikitext-upload-save-license-name", nil, NSBundle.wmf_localizationBundle, @"CC BY-SA 3.0", "Name of license user edits are saved under - presently CC BY-SA 3.0\n{{Identical|CC BY-SA}}")]
...
- (void)underlineSignIn:(UILabel *)label {
    ...
    label.attributedText =
        [label.text attributedStringWithAttributes:baseAttributes
                               substitutionStrings:@[NSLocalizedStringWithDefaultValue(@"wikitext-upload-save-sign-in", nil, NSBundle.wmf_localizationBundle, @"Log in", "{{Identical|Log in}}")]
