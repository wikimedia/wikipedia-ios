...
- (void)setupShareOptions {
    ...
    shareOptionsView.shareAsCardLabel.text = NSLocalizedStringWithDefaultValue(@"share-as-image", nil, NSBundle.wmf_localizationBundle, @"Share as image", "Button label for sharing as an image card");
    shareOptionsView.shareAsTextLabel.text = NSLocalizedStringWithDefaultValue(@"share-as-text", nil, NSBundle.wmf_localizationBundle, @"Share as text", "Button label for sharing as a text snippet (instead of as an image card)");
    shareOptionsView.cancelLabel.text = NSLocalizedStringWithDefaultValue(@"share-cancel", nil, NSBundle.wmf_localizationBundle, @"Cancel", "Button which dismisses the share dialog, cancelling the action.\n{{Identical|Cancel}}");
