...
- (void)configureForUnknownDistance {
    self.distanceLabel.text = [NSLocalizedStringWithDefaultValue(@"places-unknown-distance", nil, NSBundle.wmf_localizationBundle, @"unknown distance", "Indicates that a place is an unknown distance away") lowercaseString];
}
