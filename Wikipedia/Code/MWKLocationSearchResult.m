...
+ (NSValueTransformer *)locationJSONTransformer {
  return [MTLValueTransformer
      transformerUsingForwardBlock:^id(NSArray *value, BOOL *success,
        ...
        return [[CLLocation alloc] initWithLatitude:[lat doubleValue]
...
+ (NSDictionary *)JSONKeyPathsByPropertyKey {
  ...
  /*
     coordinates is an array of objects which have lat, lon, & dist fields. pick
     the fist one and set the corresponding
     properties here.
   */
  [mapping addEntriesFromDictionary:@{
    WMF_SAFE_KEYPATH([MWKLocationSearchResult new], location) : @"coordinates",
    WMF_SAFE_KEYPATH([MWKLocationSearchResult new],
