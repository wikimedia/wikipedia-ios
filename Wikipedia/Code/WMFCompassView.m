...
- (NSString *)accessibilityLabel {
    ...
    NSString *label = NSLocalizedStringWithDefaultValue(@"compass-direction", nil, NSBundle.wmf_localizationBundle, @"at %1$@ o'clock", "Spoken description of compass direction, e.g. \"at 3 o'clock\" means \"to the right\", \"at 11 o'clock\" means \"slightly to the left\", etc. %1$@ is the hour.");
