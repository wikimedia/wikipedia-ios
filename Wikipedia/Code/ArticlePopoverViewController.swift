...
class ArticlePopoverViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        shareButton.setTitle(NSLocalizedString("action-share", value:"Share", comment:"Title for the 'Share' action\n{{Identical|Share}}"), for: .normal)
        shareButton.setImage(#imageLiteral(resourceName: "places-share"), for: .normal)
        
        readButton.setTitle(NSLocalizedString("action-read", value:"Read", comment:"Title for the 'Read' action\n{{Identical|Read}}"), for: .normal)
