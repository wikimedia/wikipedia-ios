...
extension ReferenceShowing where Self: EditPreviewViewController & WMFReferencePageViewAppearanceDelegate & UIPageViewControllerDelegate & ReferenceViewControllerDelegate {
    // MARK: - Actions
...
private extension ReferenceShowing where Self: EditPreviewViewController {
    // MARK: - Utilities
...
extension ReferenceShowing where Self: ArticleViewController & WMFReferencePageViewAppearanceDelegate & UIPageViewControllerDelegate & ReferenceViewControllerDelegate {
    // MARK: - Actions
...
private extension ReferenceShowing where Self: ArticleViewController {
    // MARK: - Utilities
    func getBoundingClientRect(for references: [WMFLegacyReference]) -> CGRect {
        guard var rect = references.first?.rect else {
            return .zero
