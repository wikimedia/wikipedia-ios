...
@objc extension WMFSettingsViewController: WMFNavigationBarConfiguring, WMFNavigationBarHiding {
    ...
    @objc func configureNavigationBarFromObjC() {
        ...
        if self.tabBarController == nil {
            ...
            closeButtonConfig = WMFNavigationBarCloseButtonConfig(text: CommonStrings.doneTitle, target: self, action: #selector(closeButtonPressed), alignment: .trailing, isCheckMark: true)
        } else {
