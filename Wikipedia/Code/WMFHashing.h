...
static inline NSUInteger flipBitsWithAdditionalRotation(NSUInteger x,
                                                        NSUInteger rotation) {
  // take the amount and adjust it by half the size of x, so a rotation of 0
  // results in flipping the bits
