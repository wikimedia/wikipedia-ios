...
/// User-readable name for @c languageCode in the the language specified in the
/// current device language.
@property(readonly, copy, nonatomic) NSString *localizedName;

/// User-readable name for @c languageCode in the language specified by @c
/// languageCode.
...
/// @return A url with the default Wikipedia domain and the receiver's @c
/// languageCode.
- (NSURL *)siteURL;

/// @return A url whose domain & path are derived from the receiver's @c
/// languageCode and @c pageTitleText.
- (NSURL *)articleURL;
