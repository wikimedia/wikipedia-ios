 ...
 *
 *  Visual tests require that the application has a @c keyWindow, and we don't
 * pass the regular application delegate to
...
- (BOOL)application:(UIApplication *)application
  ...
  // HAX: usually session singleton does this, but we need to do it manually
  // before any tests run to ensure
