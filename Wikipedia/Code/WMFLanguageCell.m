...
- (void)setIsPrimary:(BOOL)isPrimary {
    ...
    if (isPrimary) {
        self.primaryLabel.text = [NSLocalizedStringWithDefaultValue(@"settings-primary-language", nil, NSBundle.wmf_localizationBundle, @"Primary", "Label shown next to primary language\n{{Identical|Primary}}") uppercaseStringWithLocale:[NSLocale currentLocale]];
