...
@property(strong, nonatomic)
    IBOutlet NSLayoutConstraint *localizedLanguageLabelHeight;
...
- (void)setIsPreferred:(BOOL)isPreferred {
  ...
  if (isPreferred) {
    self.localizedLanguageLabel.font =
        [UIFont systemFontOfSize:WMFPreferredTitleFontSize];
    self.articleTitleLabel.font =
        [UIFont systemFontOfSize:WMFPreferredTitleFontSize];
    self.languageNameLabel.font =
        [UIFont systemFontOfSize:WMFPreferredLanguageFontSize];
  } else {
    self.localizedLanguageLabel.font =
        [UIFont systemFontOfSize:WMFOtherTitleFontSize];
    self.articleTitleLabel.font =
        [UIFont systemFontOfSize:WMFOtherTitleFontSize];
    self.languageNameLabel.font =
        [UIFont systemFontOfSize:WMFOtherLanguageFontSize];
  }
}
...
- (void)setLanguageName:(NSString *)languageName {
  if ([self shouldShowLanguageName:languageName]) {
    self.localizedLanguageLabelHeight.constant =
        WMFLocalizedLanguageLabelHeight;
  }
  _languageName = languageName;
  self.languageNameLabel.text =
      [languageName wmf_stringByCapitalizingFirstCharacter];
}
...
- (void)setIsPrimary:(BOOL)isPrimary {
  ...
  if (isPrimary) {
    self.primaryLabel.text =
        [MWLocalizedString(@"settings-primary-language", nil)
            uppercaseStringWithLocale:[NSLocale currentLocale]];
    self.primaryLabelContainerView.backgroundColor =
        [UIColor wmf_primaryLanguageLabelBackgroundColor];
  } else {
