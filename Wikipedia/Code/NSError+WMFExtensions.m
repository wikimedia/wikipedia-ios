...
NSString *const WMFFailingRequestParametersUserInfoKey =
    @"WMFFailingRequestParametersUserInfoKey";
...
- (BOOL)wmf_shouldFallbackToDesktopURLError {
  if (self.domain == NSStreamSocketSSLErrorDomain ||
      (self.domain == NSURLErrorDomain &&
       ...
       // error.code == NSURLErrorCannotLoadFromNetwork) //TODO: check this out
       // later?
       )) {
    return YES;
  }
