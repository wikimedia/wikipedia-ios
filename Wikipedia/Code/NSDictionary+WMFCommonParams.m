...
+ (instancetype)wmf_titlePreviewRequestParameters {
  return [self
      wmf_titlePreviewRequestParametersWithExtractLength:
          WMFNumberOfExtractCharacters
                                              imageWidth:
                                                  [[UIScreen mainScreen]
...
wmf_titlePreviewRequestParametersWithExtractLength:(NSUInteger)extractLength
  ...
  NSMutableDictionary *defaults = [[NSMutableDictionary alloc]
      initWithObjectsAndKeys:@"", @"continue", @"json", @"format", @"query",
                             @"action",
                             @"pageterms|pageimages|pageprops|revisions",
                             @"prop",
                             // pageprops
                             @"ppprop", @"ns",
                             // pageterms
                             ...
                             // pageimage
                             @"thumbnail", @"piprop", imageWidth,
                             @"pithumbsize",
                             // revision
                             @(1), @"rrvlimit", @"ids", @"rvprop", nil];
  ...
  if (extractLength > 0) {
    ...
    defaults[@"prop"] =
        [defaults[@"prop"] stringByAppendingString:@"|extracts"];
  }
