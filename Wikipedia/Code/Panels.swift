...
class SyncEnabledPanelViewController: ScrollableEducationPanelViewController {
    override func viewDidLoad() {
        ...
        subheading = WMFLocalizedString("reading-list-sync-enabled-panel-message", value: "Reading list syncing is enabled for this account. To stop syncing, you can turn sync off for this account by updating you settings.", comment: "Message for panel informing user that sync is enabled for their account.")
