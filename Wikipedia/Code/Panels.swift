...
extension UIViewController {
    ...
    func wmf_showLoginViewController(category: EventCategoryMEP? = .loginToSyncPopover, theme: Theme, loginSuccessCompletion: (() -> Void)? = nil, loginDismissedCompletion: (() -> Void)? = nil) {
