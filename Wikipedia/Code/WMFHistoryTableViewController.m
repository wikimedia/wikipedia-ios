...
- (void)viewDidLoad {
  ...
  WMFRecentPagesDataSource *ds = [[WMFRecentPagesDataSource alloc]
      initWithRecentPagesList:[self historyList]];

  ds.cellClass = [WMFArticleListTableViewCell class];

  @weakify(self);
  ds.cellConfigureBlock =
      ^(WMFArticleListTableViewCell *cell, MWKHistoryEntry *entry,
...
- (void)viewDidAppear:(BOOL)animated {
  ...
  [NSUserActivity
      wmf_makeActivityActive:[NSUserActivity wmf_recentViewActivity]];
}
