...
- (void)awakeFromNib {
    [super awakeFromNib];
    self.title = NSLocalizedStringWithDefaultValue(@"history-title", nil, NSBundle.wmf_localizationBundle, @"History", "Title of the history screen shown on history tab\n{{Identical|History}}");
}
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
    ...
    if ([calendar isDateInToday:date]) {
        return [padding stringByAppendingString:[NSLocalizedStringWithDefaultValue(@"history-section-today", nil, NSBundle.wmf_localizationBundle, @"Today", "Subsection label for list of articles browsed today.\n{{Identical|Today}}") uppercaseString]];
    } else if ([calendar isDateInYesterday:date]) {
        return [padding stringByAppendingString:[NSLocalizedStringWithDefaultValue(@"history-section-yesterday", nil, NSBundle.wmf_localizationBundle, @"Yesterday", "Subsection label for list of articles browsed yesterday.\n{{Identical|Yesterday}}") uppercaseString]];
    } else {
...
- (NSString *)deleteButtonText {
    return NSLocalizedStringWithDefaultValue(@"history-clear-all", nil, NSBundle.wmf_localizationBundle, @"Clear", "Text of the button shown at the top of history which deletes all history\n{{Identical|Clear}}");
}

- (NSString *)deleteAllConfirmationText {
    return NSLocalizedStringWithDefaultValue(@"history-clear-confirmation-heading", nil, NSBundle.wmf_localizationBundle, @"Are you sure you want to delete all your recent items?", "Heading text of delete all confirmation dialog");
}

- (NSString *)deleteText {
    return NSLocalizedStringWithDefaultValue(@"history-clear-delete-all", nil, NSBundle.wmf_localizationBundle, @"Yes, delete all", "Button text for confirming delete all action");
}

- (NSString *)deleteCancelText {
    return NSLocalizedStringWithDefaultValue(@"history-clear-cancel", nil, NSBundle.wmf_localizationBundle, @"Cancel", "Button text for cancelling delete all action\n{{Identical|Cancel}}");
}
