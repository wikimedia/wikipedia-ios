...
- (void)awakeFromNib {
    ...
    [self.dismissButton setTitle:NSLocalizedStringWithDefaultValue(@"announcements-dismiss", nil, NSBundle.wmf_localizationBundle, @"No thanks", "Button text indicating a user wants to dismiss an announcement\n{{Identical|No thanks}}") forState:UIControlStateNormal];
