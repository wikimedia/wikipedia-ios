...
/// @return A substring of the receiver starting at @c index or an empty string
/// if the recevier is too short.
...
/**
 * Get the MIME type for a string obtained via another string or URL's
