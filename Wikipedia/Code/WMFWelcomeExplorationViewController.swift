...
class WMFWelcomeExplorationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        exploreDescriptionLabel.text = WMFLocalizedString("welcome-exploration-explore-feed-description", value:"Dive into Wikipedia with a constantly updating feed", comment:"Description for Explore feed")
    ...
    override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
        ...
        exploreTitleLabel.font = UIFont.wmf_preferredFontForFontFamily(.systemBold, withTextStyle: .subheadline, compatibleWithTraitCollection: traitCollection)
        placesTitleLabel.font = UIFont.wmf_preferredFontForFontFamily(.systemBold, withTextStyle: .subheadline, compatibleWithTraitCollection: traitCollection)
        onThisDayTitleLabel.font = UIFont.wmf_preferredFontForFontFamily(.systemBold, withTextStyle: .subheadline, compatibleWithTraitCollection: traitCollection)
    }
}
