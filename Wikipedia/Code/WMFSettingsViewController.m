...
- (nullable NSString *)title {
    return NSLocalizedStringWithDefaultValue(@"settings-title", nil, NSBundle.wmf_localizationBundle, @"Settings", "Title of the view where app settings are displayed.\n{{Identical|Settings}}");
}
...
- (void)showLogoutActionSheet {
    UIAlertController *sheet = [UIAlertController alertControllerWithTitle:NSLocalizedStringWithDefaultValue(@"main-menu-account-logout-are-you-sure", nil, NSBundle.wmf_localizationBundle, @"Are you sure you want to log out?", "Header asking if user is sure they wish to log out.") message:nil preferredStyle:UIAlertControllerStyleAlert];
    @weakify(self)
        [sheet addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"main-menu-account-logout", nil, NSBundle.wmf_localizationBundle, @"Log out", "Button text for logging out. The username of the user who is currently logged in is displayed after the message, e.g. Log out ExampleUserName.\n{{Identical|Log out}}")
    ...
    [sheet addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"main-menu-account-logout-cancel", nil, NSBundle.wmf_localizationBundle, @"Cancel", "Button text for hiding the log out menu.\n{{Identical|Cancel}}") style:UIAlertActionStyleCancel handler:NULL]];
...
- (void)showClearCacheActionSheet {
    ...
    [sheet addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"settings-clear-cache-cancel", nil, NSBundle.wmf_localizationBundle, @"Cancel", "Cancel action to clear cached data\n{{Identical|Cancel}}") style:UIAlertActionStyleCancel handler:NULL]];
...
- (SSSection *)section_3 {
    ...
    section.header = NSLocalizedStringWithDefaultValue(@"main-menu-heading-legal", nil, NSBundle.wmf_localizationBundle, @"Privacy and Terms", "Header text for the legal section of the menu. Consider using something informal, but feel free to use a more literal translation of \"Legal info\" if it seems more appropriate.");
    section.footer = NSLocalizedStringWithDefaultValue(@"preference-summary-eventlogging-opt-in", nil, NSBundle.wmf_localizationBundle, @"Allow Wikimedia Foundation to collect information about how you use the app to make the app better", "Description of preference that when checked enables data collection of user behavior.");
    return section;
}
...
- (SSSection *)section_4 {
    ...
    section.header = NSLocalizedStringWithDefaultValue(@"main-menu-heading-zero", nil, NSBundle.wmf_localizationBundle, @"Wikipedia Zero", "Header text for the Wikipedia Zero section of the menu. ([http://wikimediafoundation.org/wiki/Wikipedia_Zero More information]).\n{{Identical|Wikipedia Zero}}");
    section.footer = nil;
    return section;
}
...
- (nullable SSSection *)section_6 {
    ...
    section.header = NSLocalizedStringWithDefaultValue(@"main-menu-heading-debug", nil, NSBundle.wmf_localizationBundle, @"Debug", "Header text for the debug section of the menu. The debug menu is conditionally shown if in Xcode debug mode.\n{{Identical|Debug}}");
    section.footer = nil;
    return section;
}
