...
extension ArticleViewController {
    ...
    func donateDidSetMaybeLater(metricsID: String) {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
            ...
            WMFAlertManager.sharedInstance.showAlertWithMessage(title, subtitle: nil, image: WMFSFSymbolIcon.for(symbol: .checkmarkCircleFill), duration: -1, dismissPreviousAlerts: true)
        }
    }
