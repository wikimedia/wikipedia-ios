...
- (NSString *)wmf_picOfTheDayPageTitleForLanguage:(NSString *)language {
  NSString *potdTitleDateComponent =
      [[NSDateFormatter wmf_englishHyphenatedYearMonthDayFormatter]
          stringFromDate:self];
  NSParameterAssert(potdTitleDateComponent);
  return [WMFPOTDTitlePrefix
      stringByAppendingFormat:@"/%@_(%@)", potdTitleDateComponent, language];
}
