...
- (void)viewDidLoad {
    ...
    self.titleLabel.attributedText =
        [[NSLocalizedStringWithDefaultValue(@"reference-title", nil, NSBundle.wmf_localizationBundle, @"Reference %1$@", "Title shown above reference/citation popover. $1 is replaced with the reference link text - i.e. '[1]'\n{{Identical|Reference}}") uppercaseStringWithLocale:[NSLocale currentLocale]]
