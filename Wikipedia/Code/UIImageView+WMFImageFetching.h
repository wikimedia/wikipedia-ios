 ...
 */
- (void)wmf_setImageWithURL:(NSURL *)imageURL detectFaces:(BOOL)detectFaces onGPU:(BOOL)onGPU optimize:(BOOL)optimize failure:(WMFErrorHandler)failure success:(WMFSuccessHandler)success;
 ...
 *  @param detectFaces Set to YES to detect faces.
 */
- (void)wmf_setImageWithMetadata:(MWKImage *)imageMetadata detectFaces:(BOOL)detectFaces onGPU:(BOOL)onGPU optimize:(BOOL)optimize failure:(WMFErrorHandler)failure success:(WMFSuccessHandler)success;
