...
@property(nonatomic, weak)
    id<WMFImageGalleryViewControllerReferenceViewDelegate>
        referenceViewDelegate;

/**
 *  Do not use the deelgate from NYTPhotosViewController
 *  Instead use the referenceViewDelegate above.
 */
- (void)setDelegate:(nullable id<NYTPhotosViewControllerDelegate>)delegate
    NS_UNAVAILABLE;
...
@interface WMFArticleImageGalleryViewController
    : WMFImageGalleryViewController <WMFImageInfoControllerDelegate>
...
- (instancetype)initWithPhotos:(nullable NSArray<id<NYTPhoto>> *)photos
                  initialPhoto:(nullable id<NYTPhoto>)initialPhoto
                      delegate:
                          (nullable id<NYTPhotosViewControllerDelegate>)delegate
    NS_UNAVAILABLE;
