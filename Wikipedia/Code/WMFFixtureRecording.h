...
#define WMFRecordDataFixture(data, folder, name)                               \
  _WMFRecordDataFixture((data), (folder), (name))
extern void _WMFRecordDataFixture(NSData *data, NSString *folder,
                                  NSString *name);

extern void _WMFRecordFixtureWithBlock(NSString *folder, NSString *filename,
