...
- (void)updateWithInvalidationContext:(nonnull WMFCVLInvalidationContext *)context delegate:(nullable id <WMFCollectionViewLayoutDelegate>)delegate collectionView:(nullable UICollectionView *)collectionView;
