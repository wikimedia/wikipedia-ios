...
fileprivate struct FooterLocalizedStrings: JSONEncodable {
    ...
    init(for article: MWKArticle) {
        ...
        menuLastEditedTitle = String.localizedStringWithFormat(WMFLocalizedString("page-last-edited",  language: lang, value: "{{PLURAL:%1$d|0=Edited today|Edited yesterday|Edited %1$d days ago}}", comment: "Relative days since an article was last edited. 0 = today, singular = yesterday. %1$d will be replaced with appropriate plural for number of days ago."), days)
