...
- (void)viewDidLoad {
    ...
    self.buttonX.accessibilityLabel = WMFLocalizedStringWithDefaultValue(@"menu-cancel-accessibility-label-1", nil, nil, @"Cancel", @"Accessible label text for toolbar cancel button\n{{Identical|Cancel}}");
