...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler {
    ...
    if ([[self class] isLicenseURL:requestURL]) {
        ...
        vc.headerText = [NSLocalizedStringWithDefaultValue(@"about-libraries-licenses-title", nil, NSBundle.wmf_localizationBundle, @"We love open source software %1$@", "Title for list of library licenses. $1 will be replaced with an emoji expressing our love for open source software") stringByReplacingOccurrencesOfString:@"$1" withString:@"💖"];
