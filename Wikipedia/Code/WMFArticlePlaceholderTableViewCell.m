...
- (void)awakeFromNib {
    ...
    [self.placeholderSaveButton setTitle:NSLocalizedStringWithDefaultValue(@"button-save-for-later", nil, NSBundle.wmf_localizationBundle, @"Save for later", "Longer button text for save button used in various places.") forState:UIControlStateNormal];
