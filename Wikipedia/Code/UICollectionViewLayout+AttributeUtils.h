...
/// The @c NSIndexPath for the item closest to the current @c contentOffset.x of
/// the receiver's @c collectionView.
- (NSIndexPath *)wmf_indexPathHorizontallyClosestToContentOffset;

/**
 * Sort an array of @c UICollectionViewLayoutAttribute objects by their distance
...
/**
 * Map the receiver's <code>collectionView.indexPathsForVisibleItems</code> into
 * an array of their layout attributes.
 * @return An array of @c UICollectionViewLayoutAttributes.
 */
