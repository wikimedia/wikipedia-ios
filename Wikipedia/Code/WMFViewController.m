...
- (void)viewWillAppear:(BOOL)animated {
    ...
    self.showsNavigationBar = ([self.parentViewController isKindOfClass:[UITabBarController class]] || self.parentViewController == self.navigationController || [self.parentViewController isKindOfClass:[ResolveDestinationContainerViewController class]]) && self.navigationController.isNavigationBarHidden;
