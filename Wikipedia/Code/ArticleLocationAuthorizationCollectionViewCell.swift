...
class ArticleLocationAuthorizationCollectionViewCell: ArticleLocationExploreCollectionViewCell {
    ...
    override func setup() {
        ...
        authorizeButton.configuration = nil
        ...
        deprecatedButton.deprecatedContentEdgeInsets = UIEdgeInsets(top: 10, left: 15, bottom: 10, right: 15)
        ...
        authorizeDescriptionLabel.font = WMFFont.for(.footnote)
    ...
    override func sizeThatFits(_ size: CGSize, apply: Bool) -> CGSize {
        ...
        // Make button capsule-shaped after applying layout
        if apply {
            authorizeButton.layer.cornerRadius = authorizeButton.bounds.height / 2
