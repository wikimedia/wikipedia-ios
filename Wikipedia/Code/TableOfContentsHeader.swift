...
open class TableOfContentsHeader: UIView {
    ...
    open func headerTextForURL(_ url: URL) -> String {
        let headerString = WMFLocalizedString("table-of-contents-heading", language: url.wmf_languageCode, value: "Contents", comment: "Header text appearing above the first section in the table of contents {{Identical|Content}}")
