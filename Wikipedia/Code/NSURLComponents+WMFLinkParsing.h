...
/**
 * Create new NSString containing the full host for a Wikimedia `domain` and `languageCode` for desktop.
 *
 * @param domain        Wikimedia domain - for example: `wikimedia.org`.
 * @param languageCode   An optional Wikimedia language code. Should be ISO 639-x/IETF BCP 47 @see kCFLocaleLanguageCode - for exmaple: `en`.
 *
 * @return A new NSString containing the full host for a Wikimedia `domain` and `languageCode` for desktop.
 **/
 ...
 *
 * @return A new NSString containing the full host for a Wikimedia `domain` and `subDomain` for desktop.
 **/
+ (nonnull NSString *)wmf_hostWithDomain:(nonnull NSString *)domain
