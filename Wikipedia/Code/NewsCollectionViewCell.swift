...
public class NewsCollectionViewCell: SideScrollingCollectionViewCell {
    ...
    func updateDescriptionHTMLStyle() {
        ...
        let attributedString = descriptionHTML.wmf_attributedStringFromHTML(with: descriptionFont, boldFont: descriptionLinkFont, italicFont: descriptionFont, boldItalicFont: descriptionLinkFont, withAdditionalBoldingForMatchingSubstring:nil, boldLinks: true)
