...
@property(nonatomic, readonly, getter=isNewInterfaceEnabled)
    BOOL newInterfaceEnabled;
...
- (NSAttributedString *)headerTitle {
  return [[NSAttributedString alloc]
      initWithString:MWLocalizedString(@"explore-random-article-heading", nil)
          attributes:@{
...
- (NSAttributedString *)headerSubTitle {
  return [[NSAttributedString alloc]
      initWithString:MWSiteLocalizedString(self.searchSiteURL,
                                           @"onboarding-wikipedia", nil)
          attributes:@{
            NSForegroundColorAttributeName :
...
- (UIViewController *)detailViewControllerForItemAtIndexPath:
  ...
  if (self.isNewInterfaceEnabled) {
    return [[WMFRandomArticleViewController alloc]
        initWithArticleURL:url
...
- (UIViewController *)moreViewController {
  return
      [[WMFFirstRandomViewController alloc] initWithSiteURL:self.searchSiteURL
                                                  dataStore:self.dataStore];
}
