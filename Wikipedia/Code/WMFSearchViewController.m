...
- (void)configureSearchField {
    ...
    [self.searchField setPlaceholder:NSLocalizedStringWithDefaultValue(@"search-field-placeholder-text", nil, NSBundle.wmf_localizationBundle, @"Search Wikipedia", "Search field placeholder text")];
}
...
- (void)viewDidLoad {
    ...
    self.title = NSLocalizedStringWithDefaultValue(@"search-title", nil, NSBundle.wmf_localizationBundle, @"Search", "Title for search interface.\n{{Identical|Search}}");
