...
/// Passes setup parameters to the webpage (theme, margins, etc) and sets up a listener to receive events (link tapped, image tapped, etc) through the messaging bridge
