...
/// Name of the canonical file associated with this image, in the format @c
/// "File:Some_file_name.extension".
...
/// @warning These images can be *very* large. Special handling may be needed
/// when downloading or displaying.
