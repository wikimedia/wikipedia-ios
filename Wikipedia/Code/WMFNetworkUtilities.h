 ...
 * @return A string of the concatenated elements, or an empty string if @c props
 * is empty or @c nil.
 */
 ...
 *
 *  @param restAPIVersion The verison of the REST API to use (e.g. `1` for
 * "rest_v1").
 *
 *  @return The URL string for the "wikimedia.org" REST API endpoint verison.
 */
extern NSString *
WMFWikimediaRestAPIURLStringWithVersion(NSUInteger restAPIVersion);
