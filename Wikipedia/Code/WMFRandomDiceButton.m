...
- (void)setup {
    ...
    self.label.text = NSLocalizedStringWithDefaultValue(@"explore-randomizer", nil, NSBundle.wmf_localizationBundle, @"Randomizer", "Displayed on a button that loads another random article - it's a 'Randomizer'");
