...
class PlacesViewController: PreviewingViewController, UISearchBarDelegate, ArticlePopoverViewControllerDelegate, PlaceSearchSuggestionControllerDelegate, WMFLocationManagerDelegate, NSFetchedResultsControllerDelegate, UIPopoverPresentationControllerDelegate, ArticlePlaceViewDelegate, AnalyticsViewNameProviding, UIGestureRecognizerDelegate, TouchOutsideOverlayDelegate, PlaceSearchFilterListDelegate, ArticleLocationGrouperViewContext {
    ...
    var articleGrouper: ArticleLocationGrouper!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        articleGrouper = ArticleLocationGrouper(context: self)
    ...
    fileprivate var mapRegion: MKCoordinateRegion? {
        set {
            ...
            articleGrouper.regroupArticlesIfNecessary(forVisibleRegion: region, articleKeyToSelect: articleKeyToSelect, currentSearchRegion: currentSearchRegion, isViewModeOverlay: isViewModeOverlay, mapView: mapView, articleFetchedResultsController: articleFetchedResultsController, mapRegion: mapRegion)
    ...
    func updatePlaces() {
        ...
        articleGrouper.currentGroupingPrecision = 0
        articleGrouper.regroupArticlesIfNecessary(forVisibleRegion: mapRegion ?? mapView.region, articleKeyToSelect: articleKeyToSelect, currentSearchRegion: currentSearchRegion, isViewModeOverlay: isViewModeOverlay, mapView: mapView, articleFetchedResultsController: articleFetchedResultsController, mapRegion: mapRegion)
...
extension PlacesViewController {
    ...
    func regionDidChange() {
        ...
        articleGrouper.regroupArticlesIfNecessary(forVisibleRegion: mapView.region, articleKeyToSelect: articleKeyToSelect, currentSearchRegion: currentSearchRegion, isViewModeOverlay: isViewModeOverlay, mapView: mapView, articleFetchedResultsController: articleFetchedResultsController, mapRegion: mapRegion)
