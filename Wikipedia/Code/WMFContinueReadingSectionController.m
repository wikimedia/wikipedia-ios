...
static NSString *const WMFContinueReadingSectionIdentifier =
    @"WMFContinueReadingSectionIdentifier";
...
- (NSAttributedString *)headerTitle {
  return [[NSAttributedString alloc]
      initWithString:MWLocalizedString(@"explore-continue-reading-heading", nil)
          attributes:@{
...
- (NSAttributedString *)headerSubTitle {
  ...
  return [[NSAttributedString alloc]
      initWithString:[relativeTimeString wmf_stringByCapitalizingFirstCharacter]
          attributes:@{
            NSForegroundColorAttributeName :
...
- (void)configureCell:(WMFArticleListCollectionViewCell *)cell
  ...
  cell.descriptionText =
      [[article entityDescription] wmf_stringByCapitalizingFirstCharacter];
...
- (NSString *)summaryForArticle {
  MWKArticle *cachedArticle =
      [self.dataStore existingArticleWithURL:self.articleURL];
  if (cachedArticle.entityDescription.length) {
    return [cachedArticle
                .entityDescription wmf_stringByCapitalizingFirstCharacter];
  } else {
