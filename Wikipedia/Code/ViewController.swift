...
class ViewController: PreviewingViewController, NavigationBarHiderDelegate {
    ...
    public final func updateScrollViewInsets() {
        ...
        if scrollView.setContentInset(contentInset, verticalScrollIndicatorInsets: scrollIndicatorInsets, preserveContentOffset: true, preserveAnimation: shouldAnimateWhileUpdatingScrollViewInsets) {
