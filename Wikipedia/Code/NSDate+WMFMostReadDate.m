...
- (instancetype)wmf_bestMostReadFetchDate {
  NSInteger currentUTCHour =
      [[NSCalendar wmf_utcGregorianCalendar] component:NSCalendarUnitHour
                                              fromDate:self];
  NSInteger daysPrior =
      currentUTCHour < WMFPageviewDataAvailabilityThreshold ? -2 : -1;
  NSDate *fetchDate = [[NSCalendar wmf_utcGregorianCalendar]
