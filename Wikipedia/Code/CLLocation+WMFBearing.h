...
/**
 *  Calculate the bearing from the receiver to a given location, relative to the
 ...
 *
 *  Uses a special formula which accommodates for the Earth's approximate shape.
 * Native port of JS function
 *  @c LatLon.prototype.bearingTo on
 * http://www.movable-type.co.uk/scripts/latlong.html
 *
 *  @param location         The target destination.
 *
 *  @return The relative bearing in degrees, where a positive value goes in the
 * clockwise direction.
 */
- (CLLocationDegrees)wmf_bearingToLocation:(CLLocation *)destination;
