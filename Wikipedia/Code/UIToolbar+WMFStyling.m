...
- (void)wmf_applySolidWhiteBackgroundWithTopShadow {
  // HAX: Use a solid white background image instead of setting "translucency =
  // no" because doing so causes a bug which increases the toolbar height and
  // creates a ~200px gap between the top of the toolbar and the bottom of the
  // view above it. Very strange.
