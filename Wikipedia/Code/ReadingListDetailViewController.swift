...
class ReadingListDetailViewController: ThemeableViewController, WMFNavigationBarConfiguring {
    ...
    private func configureNavigationBar() {
        ...
        let closeButtonConfig: WMFNavigationBarCloseButtonConfig? = displayType == .modal ? WMFNavigationBarCloseButtonConfig(imageType: .plainX, target: self, action: #selector(dismissController), alignment: .leading) : nil
