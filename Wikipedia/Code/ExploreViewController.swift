    ...
    func exploreCardViewController(_ exploreCardViewController: ExploreCardViewController, didSelectItemAtIndexPath indexPath: IndexPath) {
        ...
        if contentGroup.contentGroupKind == .dailyGame {
            ...
            let localizedStrings = WMFWhichCameFirstViewModel.LocalizedStrings(
                ...
                correctFeedback: WMFLocalizedString("which-came-first-correct-feedback", value: "Correct! +1 point", comment: "Feedback message shown when the user answers correctly in the Which Came First game"),
