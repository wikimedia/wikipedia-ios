...
// Method for sub-classes of FetcherBase to call to cause the
// fetchFinishedDelegate
// to be notified via "fetchFinished:" that the fetch is finished.

// Note: FetchFinalStatus is not explicitly passed to this method - it
// determines
...
// have their responseSerializers overridden with "[AFHTTPResponseSerializer
// serializer]".)
// This is a quick way to check if the raw data response is potentially valid /
// contains
// anything useful.
