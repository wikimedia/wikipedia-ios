...
preferredLayoutAttributesFittingAttributes:
    (UICollectionViewLayoutAttributes *)attributesToFit {
  CGSize sizeToFit = attributesToFit.size;
  sizeToFit.height = UIViewNoIntrinsicMetric;

  CGSize fitSize =
      [self systemLayoutSizeFittingSize:sizeToFit
...
- (void)setHighlighted:(BOOL)highlighted {
  ...
  self.backgroundColor =
      highlighted ? [UIColor wmf_tapHighlightColor] : [UIColor whiteColor];
