...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        else
        {
            ...
            UIColor* bgColor = [UIColor hx_colorWithHexRGBAString:current[@"backgroundColor"]];
        ...
        if (image)
        {
            ...
            UIColor* imageTintColor = [UIColor hx_colorWithHexRGBAString:[current valueForKey:@"imageTintColor"]];
            if(imageTintColor){
        ...
        if (buttonCallback)
        {
            ...
            UIColor* buttonTintColor = [UIColor hx_colorWithHexRGBAString:[current valueForKey:@"buttonTintColor"]];
            if(buttonTintColor){
