    ...
    private struct TextViewModel {
        ...
        init(type: TextViewType) {
            ...
            case .caption:
                ...
                learnMoreUrl = "https://www.mediawiki.org/wiki/Special:MyLanguage/Wikimedia_Apps/iOS_Suggested_edits#Image_captions"
            case .alternativeText:
                ...
                learnMoreUrl = "https://www.mediawiki.org/wiki/Special:MyLanguage/Wikimedia_Apps/iOS_Suggested_edits#Tips_for_creating_alt-text"
            }
        }
    }
