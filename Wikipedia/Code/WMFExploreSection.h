...
/**
 *  Create a section which displays the featured article of the day for a
 * specific site.
 *
 *  @param site The site to retrieve the featured article from.
 *
 *  @return A featured article section, or @c nil if the given site doesn't
 * support featured articles.
 */
 ...
 *
 *  This is not the same as date created, as the date the section was created
 * (and how it's sorted with respect to
 ...
 *  If featured, main page, random, and nearby are from the "same day", then
 * special sorting takes precendence:
