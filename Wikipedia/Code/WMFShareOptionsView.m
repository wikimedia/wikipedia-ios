...
- (void)layoutSubviews {
  ...
  [self.cardImageViewContainer
      wmf_roundCorners:UIRectCornerTopLeft | UIRectCornerTopRight
              toRadius:kCornerRadius];
  [self.shareAsCardLabel
      wmf_roundCorners:UIRectCornerBottomLeft | UIRectCornerBottomRight
              toRadius:kCornerRadius];
