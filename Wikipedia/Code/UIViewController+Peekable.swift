...
extension UIViewController {
    ...
    fileprivate func wmf_addPeekableChildViewController(_ peekableViewController: UIViewController) {
    ...
    @objc func wmf_addPeekableChildViewController(for articleURL: URL, dataStore: MWKDataStore, theme: Theme) {
        ...
        self.wmf_addPeekableChildViewController(articlePeekPreviewViewController)
    }
}
