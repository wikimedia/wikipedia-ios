...
- (NSString *)descriptionForSearchResult:(MWKSearchResult *)result {
    ...
    NSString *redirectedResultMessage = [NSString localizedStringWithFormat:NSLocalizedStringWithDefaultValue(@"search-result-redirected-from", nil, NSBundle.wmf_localizationBundle, @"Redirected from: %1$@", "Text for search result letting user know if a result is a redirect from another article. Parameters:\n* %1$@ - article title the current search result redirected from"), mapping.redirectFromTitle];
