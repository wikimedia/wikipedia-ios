...
/**
 * Returns all languages of the receiver, sorted by name, minus unsupported
 * languages.
 *
...
/**
 *  Uniquely adds a new preferred language. The new language will be the first
 * preferred language.
 *
...
/**
 *  Uniquely appends a new preferred language. The new language will be the last
 * preferred language.
 *
...
/**
 *  Reorders a preferred language to the index given. The language must already
 * exist in a user's preferred languages
 *
