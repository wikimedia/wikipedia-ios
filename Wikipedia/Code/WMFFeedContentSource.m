...
- (BOOL)scheduleNotificationForNewsStory:(WMFFeedNewsStory *)newsStory
    ...
    NSString *title = NSLocalizedStringWithDefaultValue(@"in-the-news-title", nil, NSBundle.wmf_localizationBundle, @"In the news", "Title for the 'In the news' notification & feed section");
