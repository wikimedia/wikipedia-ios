...
- (instancetype)initWithDictionary:(NSDictionary *)dictionaryValue
  ...
  NSDictionary *defaults = @{
    WMF_SAFE_KEYPATH(WMFPageHistoryRevision.new, authorIcon) :
        WIKIGLYPH_USER_SMILE
  };
  dictionaryValue =
      [defaults mtl_dictionaryByAddingEntriesFromDictionary:dictionaryValue];
...
+ (NSDictionary *)JSONKeyPathsByPropertyKey {
  return @{
    ...
    WMF_SAFE_KEYPATH(WMFPageHistoryRevision.new, parsedComment) :
        @"parsedcomment",
    ...
    WMF_SAFE_KEYPATH(WMFPageHistoryRevision.new, articleSizeAtRevision) :
        @"size",
...
+ (NSValueTransformer *)revisionDateJSONTransformer {
  return [MTLValueTransformer
      transformerUsingForwardBlock:^(NSString *timeStamp, BOOL *success,
...
+ (NSValueTransformer *)authorIconJSONTransformer {
  return [MTLValueTransformer
      transformerUsingForwardBlock:^(NSString *anon, BOOL *success,
                                     NSError *__autoreleasing *error) {
