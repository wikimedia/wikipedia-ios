...
class AccountViewController: SubSettingsViewController {
    ...
    private lazy var sections: [Section] = {
        ...
        let vanishAccount = Item(title: WMFLocalizedString("account-request-vanishing", value: "Vanish account", comment: "This will initiate the process of requesting your account to be vanished "), subtitle: nil, iconName: "vanish-account", iconColor: .white, iconBackgroundColor: .red, type: .vanishAccount)
