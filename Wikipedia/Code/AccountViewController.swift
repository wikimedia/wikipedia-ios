...
class AccountViewController: SubSettingsViewController {
    ...
    private lazy var sections: [Section] = {
        ...
        let logout = Item(title: username, subtitle: CommonStrings.logoutTitle, iconName: "settings-user", iconColor: .white, iconBackgroundColor: UIColor.orangeWiki, type: .logout)
