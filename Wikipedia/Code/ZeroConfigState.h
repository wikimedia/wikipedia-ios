...
/**
 *  This is currently unused, as apparently Varnish will figure this out from
 * your IP address.
 */
...
/**
 *  Whether or not the user prefers to see a modal alert before going to a
 * non-zero-rated URL (i.e. off of Wikipedia).
 */
