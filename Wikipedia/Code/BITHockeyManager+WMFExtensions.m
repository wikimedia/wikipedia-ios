...
+ (NSString *)crashSendText {
    return WMFLocalizedStringWithDefaultValue(@"hockeyapp-alert-send-report", nil, NSBundle.wmf_localizationBundle, @"Send report", @"Alert dialog button text for crash reporting to be sent");
}

+ (NSString *)crashAlwaysSendText {
    return WMFLocalizedStringWithDefaultValue(@"hockeyapp-alert-always-send", nil, NSBundle.wmf_localizationBundle, @"Always send", @"Alert dialog button text for crash reporting to always be sent");
}

+ (NSString *)crashDoNotSendText {
    return WMFLocalizedStringWithDefaultValue(@"hockeyapp-alert-do-not-send", nil, NSBundle.wmf_localizationBundle, @"Do not send", @"Alert dialog button text for crash reporting to not send the crash report");
}
...
- (void)wmf_setupCrashNotificationAlert {
    [[BITHockeyManager sharedHockeyManager].crashManager setAlertViewHandler:^() {
        NSString *title = [NSString localizedStringWithFormat:WMFLocalizedStringWithDefaultValue(@"hockeyapp-alert-title", nil, NSBundle.wmf_localizationBundle, @"Sorry, app crashed last time", @"Concise and conciliatory alert dialog title for crash reporting"), WMFHockeyAppServiceName];
