...
/**
 *  Create a human-readable string from the given distance, localized to @c
 * locale.
 *
...
+ (NSString *)wmf_localizedStringForDistance:(CLLocationDistance)distance
                              useMetricUnits:(BOOL)useMetricUnits;

/**
 *  Convenience for @c +wmf_localizedStringForDistance:useMetricUnits: that
 * determines whether to use metric units
