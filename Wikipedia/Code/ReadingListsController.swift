...
internal let WMFReadingListBatchRequestLimit = 8 // currently this waits until all 8 requests are done before firing off 8 new ones, should be optimized to add new requests as old ones finish
