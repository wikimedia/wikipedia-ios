...
- (void)updateActiveTitleAccessibilityButton:(UIViewController *)viewController {
    if ([viewController isKindOfClass:[WMFExploreViewController class]]) {
        ...
        vc.titleButton.accessibilityLabel = NSLocalizedStringWithDefaultValue(@"home-title-accessibility-label", nil, NSBundle.wmf_localizationBundle, @"Wikipedia, scroll to top of Explore", "Accessibility heading for the Explore page, indicating that tapping it will scroll to the top of the explore page. \"Explore\" is the same as {{msg-wikimedia|Wikipedia-ios-welcome-explore-title}}.");
...
- (void)showFirstTimeZeroOnAlertIfNeeded:(WMFZeroConfiguration *)zeroConfiguration {
    ...
    NSString *title = zeroConfiguration.message ? zeroConfiguration.message : NSLocalizedStringWithDefaultValue(@"zero-free-verbiage", nil, NSBundle.wmf_localizationBundle, @"Free Wikipedia access from your mobile operator (data charges waived)", "Alert text for Wikipedia Zero free data access enabled");

    UIAlertController *dialog = [UIAlertController alertControllerWithTitle:title message:NSLocalizedStringWithDefaultValue(@"zero-learn-more", nil, NSBundle.wmf_localizationBundle, @"Data charges are waived for this Wikipedia app.", "Alert text for learning more about Wikipedia Zero") preferredStyle:UIAlertControllerStyleAlert];

    [dialog addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"zero-learn-more-no-thanks", nil, NSBundle.wmf_localizationBundle, @"Dismiss", "Button text for declining to learn more about Wikipedia Zero.\n{{Identical|Dismiss}}") style:UIAlertActionStyleCancel handler:NULL]];

    [dialog addAction:[UIAlertAction actionWithTitle:NSLocalizedStringWithDefaultValue(@"zero-learn-more-learn-more", nil, NSBundle.wmf_localizationBundle, @"Read more", "Button text for learn more about Wikipedia Zero.\n{{Identical|Read more}}")
...
- (void)showZeroOffAlert {
    ...
    UIAlertController *dialog = [UIAlertController alertControllerWithTitle:NSLocalizedStringWithDefaultValue(@"zero-charged-verbiage", nil, NSBundle.wmf_localizationBundle, @"Wikipedia Zero is off", "Alert text for Wikipedia Zero free data access disabled") message:NSLocalizedStringWithDefaultValue(@"zero-charged-verbiage-extended", nil, NSBundle.wmf_localizationBundle, @"Loading other articles may incur data charges. Saved articles stored offline do not use data and are free.", "Extended text describing that further usage of the app may in fact incur data charges because Wikipedia Zero is off, but Saved articles are still free.") preferredStyle:UIAlertControllerStyleAlert];
