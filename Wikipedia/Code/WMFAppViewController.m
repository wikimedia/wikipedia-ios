...
- (SearchViewController *)searchViewController {
    if (!_searchViewController) {
        _searchViewController = [[SearchViewController alloc] initWithSource:EventLoggingSourceSearchTab customArticleCoordinatorNavigationController:nil needsAttachedView: NO];
...
- (void)showSearchInCurrentNavigationControllerAnimated:(BOOL)animated {
    ...
    if (searchVC) {
        ...
        searchVC = [[SearchViewController alloc] initWithSource:EventLoggingSourceUnknown customArticleCoordinatorNavigationController:nc needsAttachedView:NO];
