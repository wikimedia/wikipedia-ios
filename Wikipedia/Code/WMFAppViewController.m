...
- (void)updatePrimaryWikiHasTempAccountsStatusIfNecessary {
    ...
    if (shouldCheckTempAccountWikis) {
        [[WMFTempAccountDataController shared] checkWikiTempAccountAvailabilitySyncBridgeWithLanguage:self.dataStore.languageLinkController.appLanguage.languageCode isCheckingPrimaryWiki:YES];
    }
}
