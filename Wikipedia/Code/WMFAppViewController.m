...
- (WMFArticleContainerViewController *)showArticleForURL:(NSURL *)articleURL animated:(BOOL)animated {
...
- (WMFArticleContainerViewController *)showArticleForURL:(NSURL *)articleURL animated:(BOOL)animated completion:(nonnull dispatch_block_t)completion {
    ...
    WMFArticleContainerViewController *visibleArticleViewController = self.visibleArticleViewController;
    ...
    WMFArticleContainerViewController *articleVC = [[WMFArticleContainerViewController alloc] initWithArticleURL:articleURL dataStore:self.session.dataStore theme:self.theme];
...
- (void)showNewArticleForURL:(NSURL *)articleURL animated:(BOOL)animated completion:(nonnull dispatch_block_t)completion {
    ...
    WMFArticleContainerViewController *articleVC = [[WMFArticleContainerViewController alloc] initWithArticleURL:articleURL dataStore:self.dataStore theme:self.theme];
...
- (WMFArticleContainerViewController *)visibleArticleViewController {
    UINavigationController *navVC = self.navigationController;
    UIViewController *topVC = navVC.topViewController;
    if ([topVC isKindOfClass:[WMFArticleContainerViewController class]]) {
        return (WMFArticleContainerViewController *)topVC;
    }
    return nil;
}
...
- (void)updateActiveTitleAccessibilityButton:(UIViewController *)viewController {
    ...
    } else if ([viewController isKindOfClass:[WMFArticleContainerViewController class]]) {
        WMFArticleContainerViewController *vc = (WMFArticleContainerViewController *)viewController;
...
- (void)userNotificationCenter:(UNUserNotificationCenter *)center didReceiveNotificationResponse:(UNNotificationResponse *)response withCompletionHandler:(void (^)(void))completionHandler {
    ...
    if ([categoryIdentifier isEqualToString:WMFInTheNewsNotificationCategoryIdentifier]) {
        ...
        if ([actionIdentifier isEqualToString:WMFInTheNewsNotificationShareActionIdentifier]) {
            WMFArticleContainerViewController *articleVC = [self showArticleForURL:articleURL animated:NO];
