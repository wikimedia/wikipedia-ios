...
- (void)applyStyleToWindow:(UIWindow*)window {
    ...
    [[UINavigationBar appearance] setBackIndicatorImage:[UIImage imageNamed:@"arrow-gray"]];
    [[UINavigationBar appearance] setBackIndicatorTransitionMaskImage:[UIImage imageNamed:@"arrow-gray"]];
