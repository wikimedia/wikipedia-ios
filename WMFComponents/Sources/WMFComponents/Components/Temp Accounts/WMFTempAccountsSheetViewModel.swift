...
public class WMFTempAccountsSheetViewModel: ObservableObject {
    ...
    public init(image: String, title: String, subtitle: String, ctaTopString: String, ctaBottomString: String, handleURL: @escaping (_ url: URL) -> Void, didTapDone: @escaping () -> Void, ctaTopButtonAction: @escaping () -> Void, ctaBottomButtonAction: @escaping () -> Void) {
        self.image = image
        self.title = title
