...
#Preview {
    WMFSurveyView(viewModel: WMFSurveyViewModel(localizedStrings: .init(title: "Reason", cancel: "Cancel", submit: "Submit", subtitle: "Improve", instructions: "Select", otherPlaceholder: "Other"), options: [WMFSurveyViewModel.OptionViewModel(text: "Image is not relevant", apiIdentifer: "notrelevant")]))
}
