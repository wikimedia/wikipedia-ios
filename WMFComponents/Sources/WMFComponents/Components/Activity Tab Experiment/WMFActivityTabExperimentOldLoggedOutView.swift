...
struct WMFActivityTabExperimentOldLoggedOutView: View {
    ...
    public init(viewModel: WMFActivityExperimentOldViewModel, loginAction: @escaping () -> Void, openHistory: @escaping () -> Void) {
