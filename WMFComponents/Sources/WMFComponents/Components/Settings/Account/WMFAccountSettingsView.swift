...
public struct WMFAccountSettingsView: View {
    @ObservedObject private var appEnvironment = WMFAppEnvironment.current
    private var theme: WMFTheme { appEnvironment.theme }

    @StateObject private var viewModel: WMFAccountSettingsViewModel

    public init(viewModel: WMFAccountSettingsViewModel) {
