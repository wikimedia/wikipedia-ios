...
// MARK: - Push Notifications Settings View

public struct WMFPushNotificationsSettingsView: View {
    @ObservedObject private var appEnvironment = WMFAppEnvironment.current
    private var theme: WMFTheme { appEnvironment.theme }

    @StateObject private var viewModel: WMFPushNotificationsSettingsViewModel

    public init(viewModel: WMFPushNotificationsSettingsViewModel) {
