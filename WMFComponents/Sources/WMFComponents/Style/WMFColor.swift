...
public enum WMFColor {
    ...
    public static let blue100alpha = UIColor(0xEAF3FF, alpha: 0.3)
    ...
    public static let green100alpha = UIColor(0xD5FDF4, alpha: 0.3)
    ...
    public static let orange100alpha = UIColor(0xF8F1E3, alpha: 0.3)
