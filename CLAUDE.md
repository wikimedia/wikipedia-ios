...
- `WMFComponentNavigationController` - navigation controller used for all of our navigation controllers. It contains reusable theming code that leans on the UIAppearance API.
...
All of our themes and their semantic group color names are defined in WMFTheme. Those in turn reference particular color tokens in WMFColor.
