...
extension UIView{
    ...
    func wmf_configureForIntroAnimation(){
        ...
        let images = view.wmf_addImages(
            WMF_Welcome_Image(name: "ftux-telescope-base", frame: view.bounds, zPosition: 101, initialTransform: CGAffineTransformIdentity, finalTransform: CGAffineTransformIdentity),
            WMF_Welcome_Image(name: "ftux-telescope-tube", frame: rectCorrectingForRotate, zPosition: 101, initialTransform: rotateTransform, finalTransform: CGAffineTransformIdentity)
        )
    ...
    func wmf_configureForLanguagesAnimation(){
        ...
        view.wmf_addImages(
            WMF_Welcome_Image(name: "ftux-left-bubble", frame: view.bounds, zPosition: 101, initialTransform: CGAffineTransformMakeTranslation(-50, 0), finalTransform: CGAffineTransformIdentity),
            WMF_Welcome_Image(name: "ftux-right-bubble", frame: view.bounds, zPosition: 102, initialTransform: CGAffineTransformMakeTranslation(50, 0), finalTransform: CGAffineTransformIdentity)
        )
    ...
    func wmf_configureForAnalyticsAnimation(){
        ...
        let images = view.wmf_addImages(
            WMF_Welcome_Image(name: "ftux-file", frame: view.bounds, zPosition: 101, initialTransform: CGAffineTransformMakeTranslation(-50, 0), finalTransform: CGAffineTransformIdentity)
        )
