...
## CI Lanes
- `.github/workflows/run_ui_tests.yml` runs on `betas/*` tag pushes and manual dispatch from any tag against the `WikipediaUITests` scheme and the `English (Light)` configuration from `Test Plans/UITests.xctestplan`.
