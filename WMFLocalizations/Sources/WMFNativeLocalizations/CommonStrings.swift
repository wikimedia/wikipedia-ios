...
public class CommonStrings: NSObject {
    ...
    public static let settingsGamesSubtitle = WMFLocalizedString("settings-explore-games-subtitle", value: "Daily trivia games based Wikipedia content.", comment: "Subtitle for Games section in Explore settings")
