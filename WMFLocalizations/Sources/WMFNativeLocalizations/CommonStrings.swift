...
public class CommonStrings: NSObject {
    ...
    public static let viewOnMapTitle = WMFLocalizedString("page-location", value: "View on a map", comment: "Label for button used to show an article on the map")
...
public extension CommonStrings {
    ...
    // Topics
    static let topicArchitecture = WMFLocalizedString("wikimedia-articletopics-topic-architecture", value: "Architecture", comment: "Article topic label")
    static let topicArt = WMFLocalizedString("wikimedia-articletopics-topic-art", value: "Art", comment: "Article topic label")
    static let topicComicsAndAnime = WMFLocalizedString("wikimedia-articletopics-topic-comics-and-anime", value: "Comics and anime", comment: "Article topic label")
    static let topicEntertainment = WMFLocalizedString("wikimedia-articletopics-topic-entertainment", value: "Entertainment", comment: "Article topic label")
    static let topicFashion = WMFLocalizedString("wikimedia-articletopics-topic-fashion", value: "Fashion", comment: "Article topic label")
    static let topicLiterature = WMFLocalizedString("wikimedia-articletopics-topic-literature", value: "Literature", comment: "Article topic label")
    static let topicMusic = WMFLocalizedString("wikimedia-articletopics-topic-music", value: "Music", comment: "Article topic label")
    static let topicPerformingArts = WMFLocalizedString("wikimedia-articletopics-topic-performing-arts", value: "Performing arts", comment: "Article topic label")
    static let topicSports = WMFLocalizedString("wikimedia-articletopics-topic-sports", value: "Sports", comment: "Article topic label")
    static let topicTVAndFilm = WMFLocalizedString("wikimedia-articletopics-topic-tv-and-film", value: "TV and film", comment: "Article topic label")
    static let topicVideoGames = WMFLocalizedString("wikimedia-articletopics-topic-video-games", value: "Video games", comment: "Article topic label")
    static let topicBiographyAll = WMFLocalizedString("wikimedia-articletopics-topic-biography", value: "Biography (all)", comment: "Article topic label")
    static let topicBiographyWomen = WMFLocalizedString("wikimedia-articletopics-topic-women", value: "Biography (women)", comment: "Article topic label")
    static let topicBusinessAndEconomics = WMFLocalizedString("wikimedia-articletopics-topic-business-and-economics", value: "Business and economics", comment: "Article topic label")
    static let topicEducation = WMFLocalizedString("wikimedia-articletopics-topic-education", value: "Education", comment: "Article topic label")
    static let topicFoodAndDrink = WMFLocalizedString("wikimedia-articletopics-topic-food-and-drink", value: "Food and drink", comment: "Article topic label")
    static let topicHistory = WMFLocalizedString("wikimedia-articletopics-topic-history", value: "History", comment: "Article topic label")
    static let topicMilitaryAndWarfare = WMFLocalizedString("wikimedia-articletopics-topic-military-and-warfare", value: "Military and warfare", comment: "Article topic label")
    static let topicPhilosophyAndReligion = WMFLocalizedString("wikimedia-articletopics-topic-philosophy-and-religion", value: "Philosophy and religion", comment: "Article topic label")
    static let topicPoliticsAndGovernment = WMFLocalizedString("wikimedia-articletopics-topic-politics-and-government", value: "Politics and government", comment: "Article topic label")
    static let topicSociety = WMFLocalizedString("wikimedia-articletopics-topic-society", value: "Society", comment: "Article topic label")
    static let topicTransportation = WMFLocalizedString("wikimedia-articletopics-topic-transportation", value: "Transportation", comment: "Article topic label")
    static let topicBiology = WMFLocalizedString("wikimedia-articletopics-topic-biology", value: "Biology", comment: "Article topic label")
    static let topicChemistry = WMFLocalizedString("wikimedia-articletopics-topic-chemistry", value: "Chemistry", comment: "Article topic label")
    static let topicComputersAndInternet = WMFLocalizedString("wikimedia-articletopics-topic-computers-and-internet", value: "Computers and internet", comment: "Article topic label")
    static let topicEarthAndEnvironment = WMFLocalizedString("wikimedia-articletopics-topic-earth-and-environment", value: "Earth and environment", comment: "Article topic label")
    static let topicEngineering = WMFLocalizedString("wikimedia-articletopics-topic-engineering", value: "Engineering", comment: "Article topic label")
    static let topicGeneralScience = WMFLocalizedString("wikimedia-articletopics-topic-general-science", value: "General science", comment: "Article topic label")
    static let topicMathematics = WMFLocalizedString("wikimedia-articletopics-topic-mathematics", value: "Mathematics", comment: "Article topic label")
    static let topicMedicineAndHealth = WMFLocalizedString("wikimedia-articletopics-topic-medicine-and-health", value: "Medicine and health", comment: "Article topic label")
    static let topicPhysics = WMFLocalizedString("wikimedia-articletopics-topic-physics", value: "Physics", comment: "Article topic label")
    static let topicTechnology = WMFLocalizedString("wikimedia-articletopics-topic-technology", value: "Technology", comment: "Article topic label")
    static let topicAfrica = WMFLocalizedString("wikimedia-articletopics-topic-africa", value: "Africa", comment: "Article topic label")
    static let topicAsia = WMFLocalizedString("wikimedia-articletopics-topic-asia", value: "Asia", comment: "Article topic label")
    static let topicCentralAmerica = WMFLocalizedString("wikimedia-articletopics-topic-central-america", value: "Central America", comment: "Article topic label")
    static let topicEurope = WMFLocalizedString("wikimedia-articletopics-topic-europe", value: "Europe", comment: "Article topic label")
    static let topicNorthAmerica = WMFLocalizedString("wikimedia-articletopics-topic-north-america", value: "North America", comment: "Article topic label")
    static let topicOceania = WMFLocalizedString("wikimedia-articletopics-topic-oceania", value: "Oceania", comment: "Article topic label")
    static let topicSouthAmerica = WMFLocalizedString("wikimedia-articletopics-topic-south-america", value: "South America", comment: "Article topic label")
}
